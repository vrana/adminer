...
export default [
	{ignores: ["externals/", ".claude/"]}, // a config with only ignores is global; not globalIgnores() to not require the eslint package itself; .claude/ - Git worktrees created by Claude Code
