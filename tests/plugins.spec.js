...
// The plugins are instantiated by adminer/plugins.php, not by the local adminer-plugins/ directory.
...
test('Login', async () => {
	await goto(page, '/adminer/plugins.php');
	...
	await goto(page, '/adminer/plugins.php?username=ODBC&sql='
	...
	await goto(page, '/adminer/plugins.php?username=ODBC&db=adminer_test&sql=' + encodeURIComponent(
...
test('Export formats', async () => {
	await goto(page, '/adminer/plugins.php?username=ODBC&db=adminer_test&dump=');
...
test('Import CSV', async () => {
	await goto(page, '/adminer/plugins.php?username=ODBC&db=adminer_test&import=');
	...
	await goto(page, '/adminer/plugins.php?username=ODBC&db=adminer_test&select=singers');
	await expect(page.locator('body')).toContainText('Karel Gott');
});

test('Edit foreign', async () => {
	await goto(page, '/adminer/plugins.php?username=ODBC&db=adminer_test&edit=albums');
...
test('Configuration', async () => {
	await goto(page, '/adminer/plugins.php?username=ODBC'); // the link is printed below the list of the plugins
	...
	await goto(page, '/adminer/plugins.php?username=ODBC&config=');
...
test('Logout', async () => {
	await goto(page, '/adminer/plugins.php?username=ODBC');
