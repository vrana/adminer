...
class AdminerSqlGemini {
	...
	*/
	...
	function sqlPrintAfter() {
        echo "<div class='sql-gemini'><p>";
		echo "<textarea name='gemini' rows='5' cols='50' title='AI prompt'>" . Adminer\h($_POST["gemini"]) . "</textarea>\n";
		echo "<div><input type='button' value='Gemini'></div>" . Adminer\script("qsl('input').onclick = function () { ajax(
			'',
			req => {
