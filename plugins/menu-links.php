...
<?php
	...
	protected $translations = array(
		...
		'zh' => array(
			'' => '配置菜单中表的链接，可与 AdminerConfig 组合使用',
			'Select data' => '选择数据',
			'Show structure' => '显示结构',
			'Both' => '两者',
			'Both, select on hover' => '两者，悬停时显示选择数据',
			'Auto (select on the select page, structure otherwise)' => '自动（在选择数据页面显示选择数据，其他页面显示结构）',
			'Menu table links' => '菜单中表的链接',
			'select' => '选择',
		),
	);
}
