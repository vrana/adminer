...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'Недействительный CSRF-токен. Отправьте форму ещё раз.',
	'Comment' => 'Комментарий',
	...
	'Session expired. Please log in again.' => 'Срок действия сессии истёк, нужно снова войти в систему.',
	...
	'Alter' => 'Изменить',
	'Alter foreign key' => 'Изменить внешний ключ', // Claude Opus 5
	'Create foreign key' => 'Создать внешний ключ', // Claude Opus 5
	'ON DELETE' => 'При стирании',
	'ON UPDATE' => 'При обновлении',
	'Index Type' => 'Тип индекса',
	'length' => 'длина',
	'operator class' => 'класс операторов', // Claude Fable 5
	...
	'Grant' => 'Позволить',
	'Revoke' => 'Запретить',
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'Слишком большой объем POST-данных. Пошлите меньший объём данных или увеличьте параметр конфигурационной директивы %s.',
	'Logged in as: %s' => 'Вы вошли как: %s',
	'Functions' => 'Функции',
	...
	'Move to another database' => 'Переместить в другую базу данных',
	'Move' => 'Переместить',
	'Engine' => 'Тип таблиц',
	...
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'Поля должны иметь одинаковые типы данных, в результирующем поле должен быть индекс, данные для импорта должны существовать.',
	'Relations' => 'Отношения',
	...
	'Lists' => 'Списки',
	'Editor' => 'Редактор',
	'Data editing in a single PHP file' => 'Редактирование данных в одном PHP-файле', // Claude Opus 5
	...
	'User types' => 'Пользовательские типы', // Claude Fable 5
	'Create type' => 'Создать тип',
	'Alter type' => 'Изменить тип',
	'Type has been dropped.' => 'Тип удален.',
	'Type has been created.' => 'Создан новый тип.',
	'Type has been altered.' => 'Тип изменен.', // Claude Opus 5
	'Extensions' => 'Расширения', // Claude Opus 5
	'Version' => 'Версия', // Claude Opus 5
	'Ctrl+click on a value to modify it.' => 'Выполните Ctrl+Щелчок мышью по значению, чтобы его изменить.',
	'Use the edit link to modify this value.' => 'Изменить это значение можно с помощью ссылки «изменить».',
	'last' => 'последняя',
	...
	'Network' => 'Сеть',
	'Geometry' => 'Геометрия',
	'Ranges' => 'Диапазоны', // Claude Opus 5
	'File exists.' => 'Файл уже существует.',
	'%d query(ies) executed OK.' => array('%d запрос выполнен успешно.', '%d запроса выполнено успешно.', '%d запросов выполнено успешно.'),
	'Show only errors' => 'Только ошибки',
	'Refresh' => 'Обновить',
	'Please use one of these file extensions: %s.' => 'Используйте одно из этих расширений %s.',
	'now' => 'сейчас',
	'ltr' => 'ltr',
	...
	'All rows on this page' => 'Все строки на этой странице', // Claude Opus 5
	'Modify' => 'Изменить',
	'Loading…' => 'Загрузка…',
	...
	'Size' => 'Размер',
	'Compute' => 'Вычислить',
	'You are offline.' => 'Вы не в сети.', // Claude Fable 5
	'Menu' => 'Меню', // Claude Opus 5
	'Documentation' => 'Документация', // Claude Opus 5
	'Database management in a single PHP file' => 'Управление базой данных в одном PHP-файле', // Claude Opus 5
	...
	'There is a space in the entered password, which might be the cause.' => 'Во введённом пароле есть пробел, это может быть причиной.',
	'Unknown error.' => 'Неизвестная ошибка.',
	'The database does not support passwords.' => 'База данных не поддерживает пароль.',
	'The server accepts any password, so filling it in protects nothing.' => 'Сервер принимает любой пароль, поэтому его ввод ничего не защищает.', // Claude Opus 5
	'Require a password.' => 'Требовать пароль.', // Claude Opus 5
	'Save %s next to Adminer to require the entered password:' => 'Сохраните %s рядом с Adminer, чтобы требовался введённый пароль:', // Claude Opus 5
	'Save %s next to Adminer to require the password %s:' => 'Сохраните %s рядом с Adminer, чтобы требовался пароль %s:', // Claude Opus 5
	'Add this line to %s to require the entered password:' => 'Добавьте эту строку в %s, чтобы требовался введённый пароль:', // Claude Opus 5
	'Add this line to %s to require the password %s:' => 'Добавьте эту строку в %s, чтобы требовался пароль %s:', // Claude Opus 5
	'More options' => 'Другие возможности', // Claude Opus 5
	'Require a password verified by Adminer' => 'Требует пароль, проверяемый Adminer', // Claude Opus 5
	'Disable %s or enable the %s or %s extension.' => 'Отключите %s или включите расширения %s или %s.',
	...
	'Shadow tables' => 'Теневые таблицы', // Claude Opus 5
