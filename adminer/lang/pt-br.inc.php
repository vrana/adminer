...
Lang::$translations = array(
	...
	'Alter' => 'Alterar',
	'Alter foreign key' => 'Alterar Chave Estrangeira', // Claude Opus 5
	...
	'Lists' => 'Listas',
	'Editor' => 'Editor',
	'Data editing in a single PHP file' => 'Edição de dados em um único arquivo PHP', // Claude Opus 5
	...
	'Use the %s <a%s>plugin</a> if Adminer runs behind a reverse proxy.' => 'Use o <a%2$s>plugin</a> %1$s se o Adminer estiver sendo executado atrás de um proxy reverso.', // Claude Opus 5
	...
	'Master password expired. <a href="https://www.adminer.org/en/extension/"%s>Implement</a> the %s method to make it permanent.' => 'A senha mestra expirou. <a href="https://www.adminer.org/en/extension/"%s>Implemente</a> o método %s para torná-la permanente.', // Claude Fable 5
	...
	'There is a space in the entered password, which might be the cause.' => 'Há um espaço na senha digitada que pode ser a causa.', // Claude Fable 5
	'If you did not send this request from Adminer, close this page.' => 'Se você não enviou esta requisição pelo Adminer, feche esta página.', // Claude Fable 5
	'Not found.' => 'Não encontrado.', // Claude Opus 5
	'You can upload a large SQL file via FTP and import it from the server.' => 'Você pode enviar um arquivo SQL grande via FTP e importá-lo do servidor.', // Claude Fable 5
	...
	'Disable %s or enable the %s or %s extension.' => 'Desabilite %s ou habilite as extensões %s ou %s.', // Claude Fable 5
	'The database does not support passwords.' => 'A base de dados não suporta senha.', // Claude Fable 5
	'The server accepts any password, so filling it in protects nothing.' => 'O servidor aceita qualquer senha, portanto preenchê-la não protege nada.', // Claude Opus 5
	'Require a password.' => 'Exigir uma senha.', // Claude Opus 5
	'Save %s next to Adminer to require the entered password:' => 'Salve %s ao lado do Adminer para exigir a senha digitada:', // Claude Opus 5
	'Save %s next to Adminer to require the password %s:' => 'Salve %s ao lado do Adminer para exigir a senha %s:', // Claude Opus 5
	'Add this line to %s to require the entered password:' => 'Adicione esta linha a %s para exigir a senha digitada:', // Claude Opus 5
