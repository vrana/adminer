...
$translations = array(
	...
	'Edit' => 'تعديل',
	'Insert' => 'إنشاء',
	'Save and insert next' => 'حفظ وإنشاء التالي',
	'Delete' => 'مسح',
	'Database' => 'قاعدة بيانات',
	'Routines' => 'الروتينات',
	...
	'edit' => 'تعديل',
	'Page' => 'صفحة',
	'Query executed OK, %d row(s) affected.' => 'تم تنفيذ الاستعلام،%d عدد الأسطر المعدلة.',
	...
	'File upload' => 'رفع ملف',
	'File uploads are disabled.' => 'رفع الملفات غير مفعل.',
	'Routine has been called, %d row(s) affected.' => 'تم استدعاء الروتين، عدد الأسطر المعدلة %d.',
	'Call' => 'استدعاء',
	'No extension' => 'امتداد غير موجود',
	'None of the supported PHP extensions (%s) are available.' => 'امتدادات php المدعومة غير موجودة.',
	'Session support must be enabled.' => 'عليك تفعيل نظام الجلسات.',
	'Session expired, please login again.' => 'انتهت الجلسة، من فضلك أعد تسجيل الدخول.',
	...
	'Grant' => 'موافق',
	'Revoke' => 'إلغاء',
	'%s version: %s through PHP extension %s' => 'النسخة %s : %s عن طريق امتداد الـ PHP %s',
	'Logged as: %s' => 'تم تسجيل الدخول باسم %s',
	'Too big POST data. Reduce the data or increase the %s configuration directive.' => 'معلومات POST كبيرة جدا. قم بتقليص حجم المعلومات أو قم بزيادة قيمة %s في خيارات الـ PHP.',
	'Move up' => 'نقل للأعلى',
	...
	'History' => 'تاريخ',
	'Variables' => 'متغيرات',
	'Source and target columns must have the same data type, there must be an index on the target columns and referenced data must exist.' => 'أعمدة المصدر والهدف يجب أن تكون من نفس النوع، يجب أن يكون هناك مؤشر في أعمدة الهدف ويجب أن تكون البيانات المرجعية موجودة.',
	'Relations' => 'علاقات',
	'Run file' => 'نفذ الملف',
	'Clear' => 'مسح',
	...
	'Webserver file %s' => 'ملف %s من خادوم الويب',
