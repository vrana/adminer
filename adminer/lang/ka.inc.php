...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'უმოქმედო CSRF-ტოკენი. ფორმის კიდევ ერთხელ გაგზავნა.',
	'Comment' => 'კომენტარები',
	...
	'Session expired. Please log in again.' => 'სესიის მოქმედების დრო ამოიწურა, გაიარეთ ხელახალი ავტორიზაცია.',
	...
	'Alter' => 'შეცვლა',
	'Alter foreign key' => 'გარე გასაღების შეცვლა', // Claude Opus 5
	'Create foreign key' => 'გარე გასაღების შექმნა', // Claude Opus 5
	'ON DELETE' => 'წაშლისას',
	...
	'Grant' => 'დაშვება',
	'Revoke' => 'შეზღუდვა',
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'POST ინფორმაცია ძალიან დიდია. შეამცირეთ ზომა ან გაზარდეს POST ინფორმაციის ზომა პარამეტრებიდან %s.',
	'Logged in as: %s' => 'შესული ხართ როგორც: %s',
	'Functions' => 'ფუნქციები',
	...
	'Move to another database' => 'გადატანა სხვა ბაზაში',
	'Move' => 'გადატანა',
	'Engine' => 'ძრავი',
	'Save and continue editing' => 'შენახვა და ცვლილების გაგრძელება',
	'original' => 'საწყისი',
	...
	'Use the edit link to modify this value.' => 'ამ მნიშვნელობის შესაცვლელად გამოიყენეთ ბმული «შეცვლა».',
	'last' => 'ბოლო',
	...
	'%d query(ies) executed OK.' => '%d მოთხოვნა შესრულდა.',
	'Show only errors' => 'მხოლოდ შეცდომები',
	'Refresh' => 'განახლება',
	'Invalid schema.' => 'არასწორი სქემა.',
	'Please use one of these file extensions: %s.' => 'გამოიყენეთ ერთ-ერთი გაფართოება %s.',
	'now' => 'ახლა',
	'ltr' => 'ltr',
	...
	'Master password expired. <a href="https://www.adminer.org/en/extension/"%s>Implement</a> the %s method to make it permanent.' => 'ძირითად პაროლს ვადა გაუვიდა. <a href="https://www.adminer.org/en/extension/"%s>გამოიყენეთ</a> მეთოდი %s, რათა ის მუდმივი გახადოთ.',
	'If you did not send this request from Adminer, close this page.' => 'ეს მოთხოვნა თქვენ თუ არ გაგიგზავნაით Adminer-იდან, დახურეთ ეს ფანჯარა..',
	'You can upload a large SQL file via FTP and import it from the server.' => 'დიდი ფაილი უნდა ატვირტოთ FTP-თი და შემდეგ გაუკეთოთ იმპორტი სერვერიდან.',
	'Size' => 'ზომა',
	'Compute' => 'გამოთვლა',
	...
	'Strings' => 'ველები',
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'საწყისი და მიზნობრივი ველები უნდა იყოს ერთიდაიგივე სახეობის, მიზნობრივ ველზე უნდა იყოს ინდექსი და უნდა არსებობდეს შესაბამისი ინფორმაცია.',
	'Drop %s?' => 'წაიშალოს %s?',
	'Warnings' => 'გაფრთხილება',
	'Adminer does not support accessing a database without a password.' => 'უპაროლო წვდომა ბაზასთან არაა დაშვებული Adminer-ში.',
	'DB' => 'ბაზა',
	...
	'There is a space in the entered password, which might be the cause.' => 'პაროლში არის გამოტოვება, შეიძლება ეს ქმნის პრობლემას.',
	'Unknown error.' => 'უცნობი შეცდომა.',
	'The database does not support passwords.' => 'ბაზაში არაა მხარდაჭერილი პაროლი.',
	'Disable %s or enable the %s or %s extension.' => 'გათიშეთ %s ან ჩართეთ %s ან %s გაფართოება.',
);
