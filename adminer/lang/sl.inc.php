...
Lang::$translations = array(
	...
	'Extensions' => 'Razširitve', // Claude Opus 5
	'Version' => 'Različica', // Claude Opus 5
	...
	'Shadow tables' => 'Senčne tabele', // Claude Opus 5
	'hostname[:port] or :socket' => 'hostname[:port] ali :socket', // Claude Fable 5
	'Adminer does not support accessing a database without a password.' => 'Adminer ne podpira dostopa do baze brez gesla.', // Claude Fable 5
	...
	'Not found.' => 'Ni najdeno.', // Claude Opus 5
	...
	'Disable %s or enable the %s or %s extension.' => 'Onemogočite %s ali omogočite razširitvi %s ali %s.', // Claude Opus 5
	'The database does not support passwords.' => 'Baza ne podpira gesla.', // Claude Fable 5
	'The server accepts any password, so filling it in protects nothing.' => 'Strežnik sprejme katero koli geslo, zato njegov vnos ničesar ne ščiti.', // Claude Opus 5
	'Require a password.' => 'Zahtevaj geslo.', // Claude Opus 5
	'Save %s next to Adminer to require the entered password:' => 'Shranite %s poleg Adminerja, da bo zahtevano vneseno geslo:', // Claude Opus 5
	'Save %s next to Adminer to require the password %s:' => 'Shranite %s poleg Adminerja, da bo zahtevano geslo %s:', // Claude Opus 5
	'Add this line to %s to require the entered password:' => 'Dodajte to vrstico v %s, da bo zahtevano vneseno geslo:', // Claude Opus 5
	'Add this line to %s to require the password %s:' => 'Dodajte to vrstico v %s, da bo zahtevano geslo %s:', // Claude Opus 5
	'More options' => 'Več možnosti', // Claude Opus 5
	'Require a password verified by Adminer' => 'Zahteva geslo, ki ga preveri Adminer', // Claude Opus 5
