...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'Token CSRF invalide. Veuillez renvoyer le formulaire.',
	'Comment' => 'Commentaire',
	...
	'Session expired. Please log in again.' => 'Session expirée, veuillez vous authentifier à nouveau.',
	...
	'Alter' => 'Modifier',
	'Alter foreign key' => 'Modifier la clé étrangère',
	'Create foreign key' => 'Créer une clé étrangère',
	'ON DELETE' => 'ON DELETE',
	'ON UPDATE' => 'ON UPDATE',
	'Index Type' => 'Type d\'index',
	'length' => 'longueur',
	'operator class' => 'classe d\'opérateurs',
	...
	'Logged in as: %s' => 'Authentifié en tant que : %s',
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'Données POST trop grandes. Réduisez la taille des données ou augmentez la valeur de %s dans la configuration de PHP.',
	'Export' => 'Exporter',
	'Tables' => 'Tables',
	'Data' => 'Données',
	'Output' => 'Sortie',
	...
	'Save and continue editing' => 'Enr. et continuer édition',
	'original' => 'original',
	...
	'Repair' => 'Réparer',
	'Truncate' => 'Tronquer',
	'Move to another database' => 'Déplacer vers une autre base de données',
	'Move' => 'Déplacer',
	...
	'History' => 'Historique',
	'Variables' => 'Variables',
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'Les colonnes de source et de destination doivent être du même type, il doit y avoir un index sur les colonnes de destination et les données référencées doivent exister.',
	'Relations' => 'Relations',
	...
	'Lists' => 'Listes',
	'Editor' => 'Éditeur',
	'Data editing in a single PHP file' => 'Édition de données dans un seul fichier PHP',
	...
	'Type has been altered.' => 'Le type a été modifié.',
	...
	'Use the edit link to modify this value.' => 'Utilisez le lien \'modifier\' pour modifier cette valeur.',
	'last' => 'dernière',
	...
	'now' => 'maintenant',
	'%d query(ies) executed OK.' => array('%d requête exécutée avec succès.', '%d requêtes exécutées avec succès.'),
	'Show only errors' => 'Montrer seulement les erreurs',
	'Refresh' => 'Rafraîchir',
	'Invalid schema.' => 'Schéma invalide.',
	'Please use one of these file extensions: %s.' => 'Veuillez utiliser l\'une des extensions %s.',
	'ltr' => 'ltr',
	...
	'All rows on this page' => 'Toutes les lignes de cette page',
	'Modify' => 'Modification',
	...
	'Use the %s <a%s>plugin</a> if Adminer runs behind a reverse proxy.' => 'Utilisez le <a%2$s>plugin</a> %1$s si Adminer fonctionne derrière un proxy inverse.',
	'Master password expired. <a href="https://www.adminer.org/en/extension/"%s>Implement</a> the %s method to make it permanent.' => 'Le mot de passe a expiré. <a href="https://www.adminer.org/en/extension/"%s>Implémentez</a> la méthode %s afin de le rendre permanent.',
	'You can upload a large SQL file via FTP and import it from the server.' => 'Vous pouvez uploader un gros fichier SQL par FTP et ensuite l\'importer depuis le serveur.',
	'Size' => 'Taille',
	'Compute' => 'Calcul',
	...
	'The database does not support passwords.' => 'La base de données ne supporte pas les mots de passe.',
	'The server accepts any password, so filling it in protects nothing.' => 'Le serveur accepte n\'importe quel mot de passe, le remplir ne protège donc rien.',
	'Require a password.' => 'Exiger un mot de passe.',
	'Save %s next to Adminer to require the entered password:' => 'Enregistrez %s à côté d\'Adminer pour exiger le mot de passe saisi :',
	'Save %s next to Adminer to require the password %s:' => 'Enregistrez %s à côté d\'Adminer pour exiger le mot de passe %s :',
	'Add this line to %s to require the entered password:' => 'Ajoutez cette ligne à %s pour exiger le mot de passe saisi :',
	'Add this line to %s to require the password %s:' => 'Ajoutez cette ligne à %s pour exiger le mot de passe %s :',
	'More options' => 'Plus d\'options',
	'Require a password verified by Adminer' => 'Exige un mot de passe vérifié par Adminer',
	'Disable %s or enable the %s or %s extension.' => 'Désactivez %s ou activez les extensions %s ou %s.',
	'Check has been dropped.' => 'La vérification a été supprimée.',
	'Check has been altered.' => 'La vérification a été modifiée.',
	'Check has been created.' => 'La vérification a été créée.',
	'Alter check' => 'Modifier la vérification',
	'Create check' => 'Créer une vérification',
	'Algorithm' => 'Algorithme',
	'Columns' => 'Colonnes',
	'Condition' => 'Condition',
	'Inherits from' => 'Hérite de',
	'Checks' => 'Vérifications',
	'Inherited by' => 'Héritée par',
	'Shadow tables' => 'Tables ombres',
	'hostname[:port] or :socket' => 'hostname[:port] ou :socket',
	'Thanks for using Adminer. Consider <a href="https://www.adminer.org/en/donation/">donating</a>.' => 'Merci d\'utiliser Adminer, pensez à <a href="https://www.adminer.org/en/donation/">faire un don</a>.',
	'Invalid server.' => 'Serveur invalide.',
	'Loaded plugins' => 'Plugins chargés',
	'screenshot' => 'capture d\'écran',
	'Increase %s.' => 'Augmentez %s.',
	'%s must <a%s>return an array</a>.' => '%s doit <a%s>retourner un tableau</a>.',
	'<a%s>Configure</a> %s in %s.' => '<a%s>Configurez</a> %s dans %s.',
	'Every plugin must <a%s>be an object</a>.' => 'Chaque plugin doit <a%s>être un objet</a>.',
);
