...
Lang::$translations = array(
	...
	'Alter' => 'Modifier',
	'Alter foreign key' => 'Modifier la clé étrangère', // Claude Opus 5
	'Create foreign key' => 'Créer une clé étrangère', // Claude Opus 5
	'ON DELETE' => 'ON DELETE',
	'ON UPDATE' => 'ON UPDATE',
	'Index Type' => 'Type d\'index',
	'length' => 'longueur',
	'operator class' => 'classe d\'opérateurs', // Claude Fable 5
	...
	'Lists' => 'Listes',
	'Editor' => 'Éditeur',
	'Data editing in a single PHP file' => 'Édition de données dans un seul fichier PHP', // Claude Opus 5
	...
	'Type has been altered.' => 'Le type a été modifié.', // Claude Opus 5
	...
	'All rows on this page' => 'Toutes les lignes de cette page', // Claude Opus 5
	'Modify' => 'Modification',
	...
	'Database management in a single PHP file' => 'Gestion de base de données dans un seul fichier PHP', // Claude Opus 5
	'Drop %s?' => 'Supprimer %s?',
	'overwrite' => 'écraser',
	'DB' => 'BD',
	...
	'The server accepts any password, so filling it in protects nothing.' => 'Le serveur accepte n\'importe quel mot de passe, le remplir ne protège donc rien.', // Claude Opus 5
	'Require a password.' => 'Exiger un mot de passe.', // Claude Opus 5
	'Save %s next to Adminer to require the entered password:' => 'Enregistrez %s à côté d\'Adminer pour exiger le mot de passe saisi :', // Claude Opus 5
	'Save %s next to Adminer to require the password %s:' => 'Enregistrez %s à côté d\'Adminer pour exiger le mot de passe %s :', // Claude Opus 5
	'Add this line to %s to require the entered password:' => 'Ajoutez cette ligne à %s pour exiger le mot de passe saisi :', // Claude Opus 5
	'Add this line to %s to require the password %s:' => 'Ajoutez cette ligne à %s pour exiger le mot de passe %s :', // Claude Opus 5
	'More options' => 'Plus d\'options', // Claude Opus 5
	'Require a password verified by Adminer' => 'Exige un mot de passe vérifié par Adminer', // Claude Opus 5
	...
	'Shadow tables' => 'Tables ombres', // Claude Opus 5
	...
	'Every plugin must <a%s>be an object</a>.' => 'Chaque plugin doit <a%s>être un objet</a>.', // Claude Opus 5
);
