...
$translations = array(
	...
	'Too many unsuccessful logins, try again in %d minute(s).' => array('Bạn gõ sai tài khoản quá nhiều lần, hãy thử lại sau %d  phút nữa.', 'Bạn gõ sai tài khoản quá nhiều lần, hãy thử lại sau %d  phút nữa.'),
	...
	'%d process(es) have been killed.' => array('%d tiến trình đã dừng', '%d tiến trình đã dừng'),
	'Kill' => 'Dừng',
	...
	'%d query(s) executed OK.' => array('%d câu lệnh đã chạy thành công', '%d câu lệnh đã chạy thành công'),
	'Query executed OK, %d row(s) affected.' => array('Đã thực hiện xong, ảnh hưởng đến %d dòng', 'Đã thực hiện xong, ảnh hưởng đến %d dòng'),
	...
	'Routines' => 'Routines',
	'Routine has been called, %d row(s) affected.' => array('Đã chạy routine, thay đổi %d dòng', 'Đã chạy routine, thay đổi %d dòng'),
	'Call' => 'Gọi',
	...
	'%d row(s)' => array('%s dòng', '%s dòng'),
	'Page' => 'trang',
	'last' => 'cuối',
	'Load more data' => 'Xem thêm dữ liệu',
	'Loading' => 'Đang nạp',
	'whole result' => 'toàn bộ kết quả',
	'%d byte(s)' => array('%d byte(s)', '%d byte(s)'),
	
	'Import' => 'Nhập khẩu',
	'%d row(s) have been imported.' => array('Đã nhập % dòng dữ liệu', 'Đã nhập % dòng dữ liệu'),
	...
	'%d item(s) have been affected.' => array('%d phần đã thay đổi', '%d phần đã thay đổi'),
	'New item' => 'Thêm',
	'original' => 'bản gốc',
	...
	'Send' => 'Gửi',
	'%d e-mail(s) have been sent.' => array('%d thư đã gửi', '%d thư đã gửi'),
