...
Lang::$translations = array(
	...
	'Extensions' => 'Tiện ích mở rộng', // Claude Opus 5
	'Version' => 'Phiên bản', // Claude Opus 5
	...
	'Disable %s or enable the %s or %s extension.' => 'Hãy tắt %s hoặc bật phần mở rộng %s hoặc %s.', // Claude Opus 5
