...
Lang::$translations = array(
	...
	'Login' => 'Logg inn',
	'Logout' => 'Logg ut',
	'Logged in as: %s' => 'Logget inn som: %s',
	'Logout successful.' => 'Utlogging vellykket.',
	'Invalid credentials.' => 'Ugylding innloggingsinformasjon.',
	'Master password expired. <a href="https://www.adminer.org/en/extension/"%s>Implement</a> the %s method to make it permanent.' => 'Master-passord er utløpt. <a href="https://www.adminer.org/en/extension/"%s>Implementer</a> en metode for %s for å gjøre det permanent.',
	'Language' => 'Språk',
	'Invalid CSRF token. Submit the form again.' => 'Ugylding CSRF-token - Send inn skjemaet igjen.',
	...
	'Session expired. Please log in again.' => 'Økt utløpt - vennligst logg inn på nytt.',
	...
	'%d query(ies) executed OK.' => '%d kall utført OK.',
	...
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'For stor datamengde i skjemaet. Reduser datamengden, eller øk størrelsen på %s-konfigurasjonsdirektivet.',
	'You can upload a large SQL file via FTP and import it from the server.' => 'Du kan laste opp en stor SQL-fil via FTP og importere den fra serveren.',
	'Export' => 'Eksport',
	'Output' => 'Resultat',
	'open' => 'åpne',
	'save' => 'lagre',
	...
	'Move to another database' => 'Flytt til annen database',
	'Move' => 'Flytt',
	...
	'Alter' => 'Endre',
	'Alter foreign key' => 'Endre fremmednøkkel',
	'Create foreign key' => 'Opprett fremmednøkkel',
	'ON DELETE' => 'ON DELETE',
	'ON UPDATE' => 'ON UPDATE',
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'Kilde- og mål-kolonner må ha samme datatype, det må være en indeks på mål-kolonnen, og dataene som refereres til må eksistere.',
	'Triggers' => 'Triggere',
	...
	'All rows on this page' => 'Alle rader på denne siden',
	'Modify' => 'Endre',
	'Ctrl+click on a value to modify it.' => 'Ctrl+klikk på en verdi for å endre den.',
	'Use the edit link to modify this value.' => 'Bruk rediger-lengde for å endre dennne verdien.',
	...
	'Insert' => 'Sett inn',
	'Save' => 'Lagre',
	'Save and continue editing' => 'Lagre og fortsett å redigere',
	...
	'Editor' => 'Redigering',
	'Data editing in a single PHP file' => 'Dataredigering i én enkelt PHP-fil',
	'$1-$3-$5' => '$6/$4 $1',
	'[yyyy]-mm-dd' => 'd/m [åååå]',
	'HH:MM:SS' => 'HH:MM:SS',
	'now' => 'nå',
	...
	'Please use one of these file extensions: %s.' => 'Vennligst bruk en av filendelsene %s.',
	...
	'Type has been altered.' => 'Type er endret.',
	'Alter type' => 'Endre type',
	'Extensions' => 'Utvidelser', // Claude Opus 5
	'Version' => 'Versjon', // Claude Opus 5
	'Saving…' => 'Lagrer…',
	'Check has been dropped.' => 'Kontrollen er slettet.',
	'Check has been altered.' => 'Kontrollen er endret.',
	'Check has been created.' => 'Kontrollen er opprettet.',
	'Alter check' => 'Endre kontroll',
	'Create check' => 'Opprett kontroll',
	'Drop %s?' => 'Slett %s?',
	'overwrite' => 'overskriv',
	'DB' => 'DB',
	'Algorithm' => 'Algoritme',
	...
	'%s queries are not supported.' => '%s-spørringer støttes ikke.',
	'Warnings' => 'Advarsler',
	'%d / ' => '%d / ',
	'Limit rows' => 'Begrens rader',
	'Materialized view' => 'Materialisert view',
	'Inherits from' => 'Arver fra',
	'Checks' => 'Kontroller',
	'Inherited by' => 'Arves av',
	'Shadow tables' => 'Skyggetabeller',
	'hostname[:port] or :socket' => 'hostname[:port] eller :socket',
	'Adminer does not support accessing a database without a password.' => 'Adminer støtter ikke tilgang til en database uten passord.',
	'Default value' => 'Standardverdi',
	'Too many unsuccessful logins, try again in %d minute(s).' => array('For mange mislykkede innloggingsforsøk, prøv igjen om %d minutt.', 'For mange mislykkede innloggingsforsøk, prøv igjen om %d minutter.'),
	'Use the %s <a%s>plugin</a> if Adminer runs behind a reverse proxy.' => 'Bruk <a%2$s>pluginet</a> %1$s hvis Adminer kjører bak en omvendt proxy.',
	'Thanks for using Adminer. Consider <a href="https://www.adminer.org/en/donation/">donating</a>.' => 'Takk for at du bruker Adminer, vurder å <a href="https://www.adminer.org/en/donation/">donere</a>.',
	'The action will be performed after successful login with the same credentials.' => 'Handlingen utføres etter vellykket innlogging med samme påloggingsinformasjon.',
	'Invalid server.' => 'Ugyldig server.',
	...
	'%s must <a%s>return an array</a>.' => '%s må <a%s>returnere et array</a>.',
	'<a%s>Configure</a> %s in %s.' => '<a%s>Konfigurer</a> %s i %s.',
	'Every plugin must <a%s>be an object</a>.' => 'Hver plugin må <a%s>være et objekt</a>.',
	'Disable %s or enable the %s or %s extension.' => 'Deaktiver %s eller aktiver utvidelsene %s eller %s.',
	'The database does not support passwords.' => 'Databasen støtter ikke passord.',
	'The server accepts any password, so filling it in protects nothing.' => 'Serveren godtar ethvert passord, så å fylle det ut beskytter ingenting.',
	'Require a password.' => 'Krev et passord.',
	'Save %s next to Adminer to require the entered password:' => 'Lagre %s ved siden av Adminer for å kreve det angitte passordet:',
	'Save %s next to Adminer to require the password %s:' => 'Lagre %s ved siden av Adminer for å kreve passordet %s:',
	'Add this line to %s to require the entered password:' => 'Legg til denne linjen i %s for å kreve det angitte passordet:',
	'Add this line to %s to require the password %s:' => 'Legg til denne linjen i %s for å kreve passordet %s:',
	'More options' => 'Flere valg',
	'Require a password verified by Adminer' => 'Krever et passord kontrollert av Adminer',
);
