...
Lang::$translations = array(
	...
	'Alter' => 'Modifica',
	'Alter foreign key' => 'Modifica la clau forana', // Claude Opus 5
	'Create foreign key' => 'Crea una clau forana', // Claude Opus 5
	'ON DELETE' => 'ON DELETE',
	'ON UPDATE' => 'ON UPDATE',
	...
	'Clear' => 'Suprimeix',
	'Editor' => 'Editor',
	'Data editing in a single PHP file' => 'Edició de dades en un sol fitxer PHP', // Claude Opus 5
	...
	'All rows on this page' => 'Tots els registres d\'aquesta pàgina', // Claude Opus 5
	...
	'Shadow tables' => 'Taules ombra', // Claude Opus 5
	...
	'Use the %s <a%s>plugin</a> if Adminer runs behind a reverse proxy.' => 'Utilitzeu el <a%2$s>connector</a> %1$s si Adminer s\'executa darrere d\'un proxy invers.', // Claude Opus 5
	...
	'Master password expired. <a href="https://www.adminer.org/en/extension/"%s>Implement</a> the %s method to make it permanent.' => 'La contrasenya mestra ha caducat. <a href="https://www.adminer.org/en/extension/"%s>Implementeu</a> el mètode %s perquè sigui permanent.', // Claude Fable 5
	...
	'There is a space in the entered password, which might be the cause.' => 'Hi ha un espai a la contrasenya introduïda que en podria ser la causa.', // Claude Fable 5
	'If you did not send this request from Adminer, close this page.' => 'Si no heu enviat aquesta sol·licitud des d\'Adminer, tanqueu aquesta pàgina.', // Claude Fable 5
	'You can upload a large SQL file via FTP and import it from the server.' => 'Podeu pujar un fitxer SQL gran per FTP i importar-lo des del servidor.', // Claude Fable 5
	...
	'Database management in a single PHP file' => 'Gestió de bases de dades en un sol fitxer PHP', // Claude Opus 5
	...
	'Add this line to %s to require the entered password:' => 'Afegiu aquesta línia a %s per requerir la contrasenya introduïda:', // Claude Opus 5
	'Add this line to %s to require the password %s:' => 'Afegiu aquesta línia a %s per requerir la contrasenya %s:', // Claude Opus 5
