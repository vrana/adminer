...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'Sobimatu CSRF, palun postitage vorm uuesti.',
	'Comment' => 'Kommentaar',
	...
	'Session expired. Please log in again.' => 'Sessioon on aegunud, palun logige uuesti sisse.',
	...
	'Alter' => 'Muuda',
	'Alter foreign key' => 'Muuda võõrvõtit', // Claude Opus 5
	'Create foreign key' => 'Loo uus võõrvõti', // Claude Opus 5
	'ON DELETE' => 'ON DELETE',
	'ON UPDATE' => 'ON UPDATE',
	...
	'Logged in as: %s' => 'Sisse logitud: %s',
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'POST-andmete maht on liialt suur. Palun vähendage andmeid või suurendage %s php-seadet.',
	'Export' => 'Ekspordi',
	'Tables' => 'Tabelid',
	'Data' => 'Andmed',
	'Output' => 'Väljund',
	...
	'Repair' => 'Paranda',
	'Truncate' => 'Tühjenda',
	'Move to another database' => 'Liiguta teise andmebaasi',
	'Move' => 'Liiguta',
	...
	'History' => 'Ajalugu',
	'Variables' => 'Muutujad',
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'Lähte- ja sihtveerud peavad eksisteerima ja omama sama andmetüüpi, sihtveergudel peab olema määratud indeks ning viidatud andmed peavad eksisteerima.',
	'Relations' => 'Seosed',
	...
	'Use the edit link to modify this value.' => 'Väärtuse muutmiseks kasuta muutmislinki.',
	'last' => 'viimane',
	...
	'%d query(ies) executed OK.' => array('%d päring edukalt käivitatud.', '%d päringut edukalt käivitatud.'),
	'Show only errors' => 'Kuva vaid veateateid',
	'Refresh' => 'Uuenda',
	'Invalid schema.' => 'Sobimatu skeema.',
	'Please use one of these file extensions: %s.' => 'Palun kasuta üht laiendustest %s.',
	'now' => 'nüüd',
	'ltr' => 'ltr',
