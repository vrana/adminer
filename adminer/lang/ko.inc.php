...
$ translations = array (
	...
	'Database has been renamed'=> '데이터베이스의 이름을 바꾸었다'
	...
	'Default values​​'=> '기본값'
	'% d byte (s)'=> '% d 바이트'
	'No commands to execute'=> '명령이 없습니다',
	...
	'Revoke'=> '권한 취소'
	'Logged as : % s'=> '로그 : % s'
	'Too big POST data. Reduce the data or increase the % s configuration directive'=> 'POST 데이터가 너무 큽니다. 데이터 크기를 줄이거 % s 설정을 늘리십시오 '
	'Move up'=> '상',
	'Move down'=> '아래',
	'Export'=> '내보내기'
	'Tables'=> '테이블'
	...
	'History'=> '역사',
	'Variables'=> '변수'
	'Source and target columns must have the same data type, there must be an index on the target columns and referenced data must exist'=> '원본 및 대상 열은 ​​동일한 데이터 형식이어야합니다. 목표 컬럼에 인덱스가 데이터가 존재해야합니다. '
	'Relations'=> '관계',
	'Run file'=> '파일을 실행'
	'Clear'=> '삭제',
