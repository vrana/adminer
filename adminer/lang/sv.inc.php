...
$translations = array(
	...
	'There is a space in the input password which might be the cause.' => 'Det finns ett mellanslag i lösenordet, vilket can vara anledningen.',
	...
	'Too many unsuccessful logins, try again in %d minute(s).' => array('För många misslyckade inloggningar, försök igen i %d minut.', 'För många misslyckade inloggningar, försök igen i %d minuter.'),
	...
	'The action will be performed after successful login with the same credentials.' => 'Åtgärden kommer att utföras efter en lyckad inloggning med de samma inloggningsuppgifterna.',
