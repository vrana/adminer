...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'अमान्य CSRF टोकन। फॉर्म फिर से भेजें।',
	'Comment' => 'टिप्पणी',
	...
	'Session expired. Please log in again.' => 'सेशन समाप्त, कृपया फिर से लॉगिन करें।',
	...
	'Alter' => 'बदलें',
	'Alter foreign key' => 'फॉरेन की बदलें', // Claude Opus 5
	'Create foreign key' => 'फॉरेन की बनाएं', // Claude Opus 5
	'ON DELETE' => 'ऑन डिलीट',
	'ON UPDATE' => 'ऑन अपडेट',
	...
	'Grant' => 'अनुदान',
	'Revoke' => 'रद्द करें',
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'बहुत बड़ा POST डेटा। डेटा कम करें या %s कॉन्फ़िगरेशन निर्देश बढ़ाएं।',
	'Logged in as: %s' => '%s के रूप में लॉगिन',
	'Functions' => 'फंक्शन्स',
	...
	'Rows' => 'पंक्तियां',
	'#,##0' => '#,##,##0', // Claude Opus 5
	'0123456789' => '0123456789', // Claude Opus 5
	'Tables have been moved.' => 'टेबल्स स्थानांतरित कर दिए गए हैं।',
	'Move to another database' => 'अन्य डेटाबेस में स्थानांतरित करें',
	'Move' => 'स्थानांतरित करें',
	'Engine' => 'इंजन',
	'Save and continue editing' => 'सहेजें और संपादन जारी रखें',
	'original' => 'मूल',
	...
	'History' => 'इतिहास',
	'Variables' => 'चर',
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'स्रोत और लक्ष्य कॉलम्स का डेटा प्रकार समान होना चाहिए, लक्ष्य कॉलम्स पर एक इंडेक्स होना चाहिए और संदर्भित डेटा मौजूद होना चाहिए।',
	'Relations' => 'संबंध',
	'Run file' => 'फाइल चलाएं',
	'Clear' => 'साफ़ करें',
	...
	'Use the edit link to modify this value.' => 'इस मान को संशोधित करने के लिए संपादन लिंक का उपयोग करें।',
	'last' => 'अंतिम',
	...
	'%d query(ies) executed OK.' => array('%d क्वेरी सफलतापूर्वक निष्पादित।', '%d क्वेरीज़ सफलतापूर्वक निष्पादित।'),
	'Show only errors' => 'केवल त्रुटियां दिखाएं',
	'Refresh' => 'ताज़ा करें',
	'Invalid schema.' => 'अमान्य स्कीमा।',
	'Please use one of these file extensions: %s.' => 'कृपया %s एक्सटेंशन्स में से एक का उपयोग करें।',
	'now' => 'अब',
	'ltr' => 'ltr',
	...
	'Master password expired. <a href="https://www.adminer.org/en/extension/"%s>Implement</a> the %s method to make it permanent.' => 'मास्टर पासवर्ड समाप्त हो गया। इसे स्थायी बनाने के लिए %s मेथड <a href="https://www.adminer.org/en/extension/"%s>इम्प्लीमेंट</a> करें।',
	...
	'There is a space in the entered password, which might be the cause.' => 'इनपुट पासवर्ड में एक स्पेस है जो कारण हो सकता है।',
	'If you did not send this request from Adminer, close this page.' => 'अगर आपने यह अनुरोध एडमिनर से नहीं भेजा है तो इस पेज को बंद करें।',
	'You can upload a large SQL file via FTP and import it from the server.' => 'आप एक बड़ी SQL फ़ाइल FTP के माध्यम से अपलोड कर सकते हैं और सर्वर से इम्पोर्ट कर सकते हैं।',
	'Size' => 'आकार',
	'Compute' => 'कम्प्यूट',
	...
	'Disable %s or enable the %s or %s extension.' => '%s को डिसेबल करें या %s या %s एक्सटेंशन्स को एनेबल करें।',
	'The database does not support passwords.' => 'डेटाबेस पासवर्ड का समर्थन नहीं करता।',
	'yes' => 'हाँ',
	'no' => 'नहीं',
);
