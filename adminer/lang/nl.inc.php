...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'Ongeldig CSRF token. Verstuur het formulier opnieuw.',
	'Comment' => 'Commentaar',
	...
	'Session expired. Please log in again.' => 'Uw sessie is verlopen. Gelieve opnieuw aan te melden.',
	...
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'POST-data is te groot. Verklein de hoeveelheid data of verhoog de %s configuratie.',
	'Export' => 'Exporteren',
	'Tables' => 'Tabellen',
	'Data' => 'Data',
	'Output' => 'Uitvoer',
	...
	'Save and continue editing' => 'Opslaan en verder bewerken',
	'original' => 'origineel',
	...
	'Repair' => 'Herstel',
	'Truncate' => 'Legen',
	'Move to another database' => 'Verplaats naar andere database',
	'Move' => 'Verplaats',
	...
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'Bron- en doelkolommen moeten van hetzelfde data type zijn, er moet een index bestaan op de gekozen kolommen en er moet gerelateerde data bestaan.',
	'Relations' => 'Relaties',
	...
	'Lists' => 'Lijsten',
	'Editor' => 'Editor',
	'Data editing in a single PHP file' => 'Gegevens bewerken in één PHP-bestand',
	...
	'Type has been altered.' => 'Type gewijzigd.',
	'Extensions' => 'Extensies', // Claude Opus 5
	'Version' => 'Versie', // Claude Opus 5
	'Ctrl+click on a value to modify it.' => 'Ctrl+klik op een waarde om deze te bewerken.',
	'Use the edit link to modify this value.' => 'Gebruik de link \'bewerk\' om deze waarde te wijzigen.',
	'last' => 'laatste',
	...
	'Refresh' => 'Vernieuwen',
	'Please use one of these file extensions: %s.' => 'Gebruik 1 van volgende extensies: %s.',
	'now' => 'nu',
	'ltr' => 'ltr',
	...
	'Use the %s <a%s>plugin</a> if Adminer runs behind a reverse proxy.' => 'Gebruik de <a%2$s>plugin</a> %1$s als Adminer achter een reverse proxy draait.',
	'Master password expired. <a href="https://www.adminer.org/en/extension/"%s>Implement</a> the %s method to make it permanent.' => 'Master wachtwoord verlopen. <a href="https://www.adminer.org/en/extension/"%s>Implementeer</a> de %s methode om het permanent te maken.',
	...
	'There is a space in the entered password, which might be the cause.' => 'Er staat een spatie in het wachtwoord, wat misschien de oorzaak is.',
	'If you did not send this request from Adminer, close this page.' => 'Als u deze actie niet via Adminer hebt gedaan, gelieve deze pagina dan te sluiten.',
	'Not found.' => 'Niet gevonden.', // Claude Opus 5
	'You can upload a large SQL file via FTP and import it from the server.' => 'U kan een groot SQL-bestand uploaden via FTP en het importeren via de server.',
	'Size' => 'Grootte',
	'Compute' => 'Bereken',
	'You are offline.' => 'U bent offline.',
	'Menu' => 'Menu',
	'Documentation' => 'Documentatie', // Claude Opus 5
	'Database management in a single PHP file' => 'Databasebeheer in één PHP-bestand',
	'You have no privileges to update this table.' => 'U bent niet gemachtigd om deze tabel aan te passen.',
	'Saving…' => 'Opslaan…',
	'Unknown error.' => 'Onbekende fout.',
	'The database does not support passwords.' => 'Database ondersteunt het wachtwoord niet.',
	'The server accepts any password, so filling it in protects nothing.' => 'De server accepteert elk wachtwoord, het invullen beschermt niets.',
	'Require a password.' => 'Een wachtwoord vereisen.',
	'Save %s next to Adminer to require the entered password:' => 'Sla %s naast Adminer op om het ingevoerde wachtwoord te vereisen:',
	'Save %s next to Adminer to require the password %s:' => 'Sla %s naast Adminer op om het wachtwoord %s te vereisen:',
	'Add this line to %s to require the entered password:' => 'Voeg deze regel toe aan %s om het ingevoerde wachtwoord te vereisen:',
	'Add this line to %s to require the password %s:' => 'Voeg deze regel toe aan %s om het wachtwoord %s te vereisen:',
	'More options' => 'Meer mogelijkheden',
	'Require a password verified by Adminer' => 'Vereist een door Adminer gecontroleerd wachtwoord',
	'Disable %s or enable the %s or %s extension.' => 'Schakel %s uit of schakel extensies %s of %s in.',
	'yes' => 'ja',
	'no' => 'neen',
	...
	'Inherits from' => 'Erft over van',
	'Checks' => 'Checks', //! 'Controles' in nl-NL
	'Inherited by' => 'Overgeërfd door',
	'Shadow tables' => 'Schaduwtabellen',
	'hostname[:port] or :socket' => 'hostname[:port] of :socket',
	'Thanks for using Adminer. Consider <a href="https://www.adminer.org/en/donation/">donating</a>.' => 'Bedankt voor het gebruik van Adminer, overweeg een <a href="https://www.adminer.org/en/donation/">donatie</a>.',
	'Invalid server.' => 'Ongeldige server.',
	'Loaded plugins' => 'Geladen plugins',
	'screenshot' => 'schermafbeelding',
	'Increase %s.' => 'Verhoog %s.',
	'%s must <a%s>return an array</a>.' => '%s moet <a%s>een array retourneren</a>.',
	'<a%s>Configure</a> %s in %s.' => '<a%s>Configureer</a> %s in %s.',
	'Every plugin must <a%s>be an object</a>.' => 'Elke plugin moet <a%s>een object zijn</a>.',
);
