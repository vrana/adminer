...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'כשל באבטחת נתונים, שלח טופס שוב',
	'Comment' => 'הערה',
	...
	'Session expired. Please log in again.' => 'תם זמן ההפעלה, אנא התחבר שוב',
	...
	'Alter' => 'שנה',
	'Alter foreign key' => 'שנה מפתח זר', // Claude Opus 5
	'Create foreign key' => 'צור מפתח זר', // Claude Opus 5
	'ON DELETE' => 'בעת מחיקה',
	...
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'מידע גדול מידי נשלח ב-POST. הקטן את את המידע הוא הגדלת את הגדרות ה-%s',
	'Export' => 'יצא',
	'Tables' => 'טבלאות',
	'Data' => 'נתונים',
	'Output' => 'פלט',
	...
	'Repair' => 'תקן',
	'Truncate' => 'קצר',
	'Move to another database' => 'העבר למסד נתונים אחר',
	'Move' => 'העבר',
	...
	'History' => 'היסטוריה',
	'Variables' => 'משתנים',
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'על עמודות המקור והיעד להיות מאותו טיפוס נתונים, חובה שיהיה אינדקס בעמודת היעד ושהמידע המתאים יהיה קיים',
	'Relations' => 'הקשרים',
	'Run file' => 'הרץ קובץ',
	'Clear' => 'נקה',
	...
	'Use the edit link to modify this value.' => 'השתמש בקישור העריכה בשביל לשנות את הערך',
	'last' => 'אחרון',
	'From server' => 'משרת',
	'System' => 'מערכת',
	...
	'now' => 'כעת',
	'%d query(ies) executed OK.' => '%d שאילתות בוצעו בהצלחה',
	'Show only errors' => 'הראה שגיאות בלבד',
	'Refresh' => 'רענן',
	'Invalid schema.' => 'סכמה שגויה',
	'Please use one of these file extensions: %s.' => 'בבקשה השתמש באחד מהתוספים %s',
	'ltr' => 'rtl',
	...
	'Master password expired. <a href="https://www.adminer.org/en/extension/"%s>Implement</a> the %s method to make it permanent.' => 'פג תוקף סיסמת המאסטר. <a href="https://www.adminer.org/en/extension/"%s>יש לממש</a> את המתודה %s כדי להפוך אותה לקבועה.', // Claude Fable 5
	'If you did not send this request from Adminer, close this page.' => 'אם לא אתה שלחת בקשה ל-Adminer הינך יכול לסגור חלון זה',
	'You can upload a large SQL file via FTP and import it from the server.' => 'ניתן לעלות קבצים ב-FTP ואז למשוך אותם מהשרת',
	'Size' => 'גודל',
	'Compute' => 'חישוב',
