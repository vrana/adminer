...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'Token CSRF non valido. Reinvia la richiesta.',
	'Comment' => 'Commento',
	...
	'Session expired. Please log in again.' => 'Sessione scaduta, autenticarsi di nuovo.',
	...
	'Alter' => 'Modifica',
	'Alter foreign key' => 'Modifica foreign key',
	'Create foreign key' => 'Crea foreign key',
	'ON DELETE' => 'ON DELETE',
	'ON UPDATE' => 'ON UPDATE',
	'Index Type' => 'Tipo indice',
	'length' => 'lunghezza',
	'operator class' => 'classe di operatori',
	...
	'Grant' => 'Permetti',
	'Revoke' => 'Revoca',
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'Troppi dati via POST. Ridurre i dati o aumentare la direttiva di configurazione %s.',
	'Logged in as: %s' => 'Autenticato come: %s',
	'Functions' => 'Funzioni',
	...
	'Save and continue editing' => 'Salva e continua',
	'original' => 'originale',
	...
	'Repair' => 'Ripara',
	'Truncate' => 'Svuota',
	'Move to another database' => 'Sposta in altro database',
	'Move' => 'Sposta',
	...
	'History' => 'Storico',
	'Variables' => 'Variabili',
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'Le colonne sorgente e destinazione devono essere dello stesso tipo e ci deve essere un indice sulla colonna di destinazione e sui dati referenziati.',
	'Relations' => 'Relazioni',
	...
	'Lists' => 'Liste',
	'Editor' => 'Editor',
	'Data editing in a single PHP file' => 'Modifica dei dati in un singolo file PHP',
	...
	'Type has been altered.' => 'Tipo definito dall\'utente modificato.',
	'Extensions' => 'Estensioni', // Claude Opus 5
	'Version' => 'Versione', // Claude Opus 5
	'Ctrl+click on a value to modify it.' => 'Fai Ctrl+click su un valore per modificarlo.',
	'Use the edit link to modify this value.' => 'Usa il link modifica per modificare questo valore.',
	'last' => 'ultima',
	...
	'%d query(ies) executed OK.' => array('%d query eseguita con successo.', '%d query eseguite con successo.'),
	'Show only errors' => 'Mostra solo gli errori',
	'Refresh' => 'Aggiorna',
	'Please use one of these file extensions: %s.' => 'Usa una delle estensioni %s.',
	'now' => 'adesso',
	'ltr' => 'ltr',
	...
	'All rows on this page' => 'Tutte le righe di questa pagina',
	'Modify' => 'Modifica',
	...
	'Use the %s <a%s>plugin</a> if Adminer runs behind a reverse proxy.' => 'Usare il <a%2$s>plugin</a> %1$s se Adminer è eseguito dietro un reverse proxy.',
	'Master password expired. <a href="https://www.adminer.org/en/extension/"%s>Implement</a> the %s method to make it permanent.' => 'La password principale é scaduta. <a href="https://www.adminer.org/it/extension/"%s>Implementare</a> %s come metodo per renderla permanente.',
	...
	'The database does not support passwords.' => 'Il database non supporta password.',
	'The server accepts any password, so filling it in protects nothing.' => 'Il server accetta qualsiasi password, quindi inserirla non protegge nulla.',
	'Require a password.' => 'Richiedi una password.',
	'Save %s next to Adminer to require the entered password:' => 'Salva %s accanto ad Adminer per richiedere la password inserita:',
	'Save %s next to Adminer to require the password %s:' => 'Salva %s accanto ad Adminer per richiedere la password %s:',
	'Add this line to %s to require the entered password:' => 'Aggiungi questa riga a %s per richiedere la password inserita:',
	'Add this line to %s to require the password %s:' => 'Aggiungi questa riga a %s per richiedere la password %s:',
	'More options' => 'Altre opzioni',
	'Require a password verified by Adminer' => 'Richiede una password verificata da Adminer',
	'Disable %s or enable the %s or %s extension.' => 'Disabilita %s o abilita %s oppure %s estensioni.',
	'yes' => 'si',
	'no' => 'no',
	'Check has been dropped.' => 'Controllo eliminato.',
	'Check has been altered.' => 'Controllo modificato.',
	'Check has been created.' => 'Controllo creato.',
	'Alter check' => 'Modifica controllo',
	'Create check' => 'Crea controllo',
	'Algorithm' => 'Algoritmo',
	'Columns' => 'Colonne',
	'Condition' => 'Condizione',
	'Inherits from' => 'Eredita da',
	'Checks' => 'Controlli',
	'Inherited by' => 'Ereditata da',
	'Shadow tables' => 'Tabelle ombra',
	'hostname[:port] or :socket' => 'hostname[:port] o :socket',
	'Thanks for using Adminer. Consider <a href="https://www.adminer.org/en/donation/">donating</a>.' => 'Grazie per aver usato Adminer, considera una <a href="https://www.adminer.org/en/donation/">donazione</a>.',
	'Invalid server.' => 'Server non valido.',
	'Loaded plugins' => 'Plugin caricati',
	'screenshot' => 'screenshot',
	'Increase %s.' => 'Aumenta %s.',
	'%s must <a%s>return an array</a>.' => '%s deve <a%s>restituire un array</a>.',
	'<a%s>Configure</a> %s in %s.' => '<a%s>Configura</a> %s in %s.',
	'Every plugin must <a%s>be an object</a>.' => 'Ogni plugin deve <a%s>essere un oggetto</a>.',
);
