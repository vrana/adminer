...
Lang::$translations = array(
	...
	'Execute' => 'ประมวลผล',
	'Table' => 'ตาราง',
	'Foreign keys' => 'คีย์นอก', // Claude Fable 5
	'Triggers' => 'ทริกเกอร์',
	'View' => 'วิว',
	'Unable to select the table' => 'ไม่สามารถเลือกตารางได้',
	'Invalid CSRF token. Submit the form again.' => 'เครื่องหมาย CSRF ไม่ถูกต้อง ส่งข้อมูลใหม่อีกครั้ง.',
	'Comment' => 'หมายเหตุ',
	...
	'Session expired. Please log in again.' => 'Session หมดอายุแล้ว กรุณาเข้าสู่ระบบใหม่อีกครั้ง.',
	'Text length' => 'ความยาวของอักษร',
	'Foreign key has been dropped.' => 'คีย์นอกถูกลบแล้ว.', // Claude Fable 5
	'Foreign key has been altered.' => 'คีย์นอกถูกเปลี่ยนแปลงแล้ว.', // Claude Fable 5
	'Foreign key has been created.' => 'คีย์นอกถูกสร้างแล้ว.', // Claude Fable 5
	'Target table' => 'ตารางเป้าหมาย', // Claude Fable 5
	'Change' => 'แก้ไข',
	'Source' => 'แหล่งข้อมูล',
	'Target' => 'เป้าหมาย',
	'Add column' => 'เพิ่มคอลัมน์',
	'Alter' => 'เปลี่ยนแปลง',
	'Alter foreign key' => 'เปลี่ยนแปลงคีย์นอก', // Claude Opus 5
	'Create foreign key' => 'สร้างคีย์นอก', // Claude Opus 5
	'ON DELETE' => 'ON DELETE',
	'ON UPDATE' => 'ON UPDATE',
	...
	'Grant' => 'การอนุญาต',
	'Revoke' => 'ยกเลิก',
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'ข้อมูลที่ส่งเข้ามีขนาดใหญ่เกิน คุณสามารถ เพิ่ม-ลดขนาดได้ที่ %s คำสั่งการตั้งค่า.',
	'Logged in as: %s' => 'สวัสดีคุณ: %s',
	'Functions' => 'ฟังก์ชั่น',
	'Aggregation' => 'รวบรวม',
	'Export' => 'ส่งออก',
	...
	'Move to another database' => 'ย้ายไปยังฐานข้อมูลอื่น',
	'Move' => 'ย้าย',
	'Engine' => 'ชนิดของฐานข้อมูล',
	'Save and continue editing' => 'บันทึกและแก้ไขข้อมูลอื่นๆต่อ',
	'original' => 'ต้นฉบับ',
	...
	'History' => 'ประวัติ',
	'Variables' => 'ตัวแปร',
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'แหล่งที่มาและเป้าหมายของคอลมัน์ต้องมีชนิดข้อมูลเดียวกัน คือต้องมีดัชนีและข้อมูลอ้างอิงของคอลัมน์เป้าหมาย.',
	...
	'User types' => 'ประเภทข้อมูลที่ผู้ใช้กำหนด', // Claude Fable 5
	...
	'Use the edit link to modify this value.' => 'ใช้ลิงค์ แก้ไข เพื่อปรับเปลี่ยนค่านี้.',
	'last' => 'ล่าสุด',
	...
	'%d query(ies) executed OK.' => '%d คำสั่งถูกดำเนินการแล้ว.',
	'Show only errors' => 'แสดงเฉพาะเออเรอ',
	'Refresh' => 'โหลดใหม่',
	'Invalid schema.' => 'schema ไม่ถูกต้อง.',
	'Please use one of these file extensions: %s.' => 'กรุณาใช้ส่วนเสริมอย่างน้อย 1 ส่วนเสริมจากทั้งหมด %s.',
	'now' => 'ตอนนี้',
	'ltr' => 'ltr',
