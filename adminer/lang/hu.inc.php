...
Lang::$translations = array(
	...
	'Refresh' => 'Frissítés',
	'Please use one of these file extensions: %s.' => 'Használja a(z) %s kiterjesztést.',
	'ltr' => 'ltr',
	...
	'Disable %s or enable the %s or %s extension.' => 'Tiltsa le a(z) %s beállítást, vagy engedélyezze a(z) %s vagy %s kiterjesztéseket.', // Claude Opus 5
	...
	'Add this line to %s to require the entered password:' => 'Adja hozzá ezt a sort a(z) %s fájlhoz, hogy a megadott jelszó legyen szükséges:', // Claude Opus 5
	'Add this line to %s to require the password %s:' => 'Adja hozzá ezt a sort a(z) %s fájlhoz, hogy a(z) %s jelszó legyen szükséges:', // Claude Opus 5
