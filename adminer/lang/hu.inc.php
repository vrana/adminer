...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'Érvénytelen CSRF azonosító. Küldd újra az űrlapot.',
	'Comment' => 'Megjegyzés',
	...
	'Session expired. Please log in again.' => 'Munkamenet lejárt, jelentkezz be újra.',
	...
	'Alter' => 'Módosítás',
	'Alter foreign key' => 'Idegen kulcs módosítása', // Claude Opus 5
	'Create foreign key' => 'Idegen kulcs létrehozása', // Claude Opus 5
	'ON DELETE' => 'törléskor',
	...
	'Grant' => 'Engedélyezés',
	'Revoke' => 'Visszavonás',
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'Túl sok a POST adat! Csökkentsd az adat méretét, vagy növeld a %s beállítást.',
	'Logged in as: %s' => 'Belépve: %s',
	'Functions' => 'Funkciók',
	...
	'Move to another database' => 'Áthelyezés másik adatbázisba',
	'Move' => 'Áthelyez',
	'Engine' => 'Motor',
	'Save and continue editing' => 'Mentés és szerkesztés folytatása',
	'original' => 'eredeti',
	...
	'History' => 'Történet',
	'Variables' => 'Változók',
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'A forrás és cél oszlopoknak azonos típusúak legyenek, a cél oszlopok indexeltek legyenek, és a hivatkozott adatnak léteznie kell.',
	...
	'Extensions' => 'Kiterjesztések', // Claude Opus 5
	'Version' => 'Verzió', // Claude Opus 5
	'Search data in tables' => 'Keresés a táblákban',
	'From server' => 'Szerverről',
	'empty' => 'üres',
	'now' => 'most',
	'%d query(ies) executed OK.' => '%d sikeres lekérdezés.',
	'Show only errors' => 'Csak a hibák mutatása',
	'Refresh' => 'Frissítés',
	'Please use one of these file extensions: %s.' => 'Használja a %s kiterjesztést.',
	'ltr' => 'ltr',
	...
	'All rows on this page' => 'Az oldal összes sora', // Claude Opus 5
	...
	'Use the %s <a%s>plugin</a> if Adminer runs behind a reverse proxy.' => 'Használja a %s <a%s>bővítményt</a>, ha az Adminer fordított proxy mögött fut.', // Claude Opus 5
	...
	'Master password expired. <a href="https://www.adminer.org/en/extension/"%s>Implement</a> the %s method to make it permanent.' => 'A mesterjelszó lejárt. <a href="https://www.adminer.org/en/extension/"%s>Implementálja</a> a %s metódust, hogy állandó legyen.', // Claude Fable 5
	...
	'Disable %s or enable the %s or %s extension.' => 'Tiltsa le a %s beállítást, vagy engedélyezze a %s vagy %s kiterjesztéseket.', // Claude Opus 5
	...
	'Save %s next to Adminer to require the entered password:' => 'Mentse az %s fájlt az Adminer mellé, hogy a megadott jelszó legyen szükséges:', // Claude Opus 5
	'Save %s next to Adminer to require the password %s:' => 'Mentse az %s fájlt az Adminer mellé, hogy a(z) %s jelszó legyen szükséges:', // Claude Opus 5
	'Add this line to %s to require the entered password:' => 'Adja hozzá ezt a sort az %s fájlhoz, hogy a megadott jelszó legyen szükséges:', // Claude Opus 5
	'Add this line to %s to require the password %s:' => 'Adja hozzá ezt a sort az %s fájlhoz, hogy a(z) %s jelszó legyen szükséges:', // Claude Opus 5
