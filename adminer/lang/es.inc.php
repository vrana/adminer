...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'Token CSRF inválido. Vuelva a enviar los datos del formulario.',
	'Comment' => 'Comentario',
	...
	'Session expired. Please log in again.' => 'Sesión caducada, por favor escriba su clave de nuevo.',
	...
	'Alter' => 'Modificar',
	'Alter foreign key' => 'Modificar clave externa',
	'Create foreign key' => 'Crear clave externa',
	'ON DELETE' => 'AL BORRAR',
	...
	'Grant' => 'Conceder',
	'Revoke' => 'Impedir',
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'POST data demasiado grande. Reduzca el tamaño o aumente la directiva de configuración %s.',
	'You can upload a large SQL file via FTP and import it from the server.' => 'Usted puede cargar un SQL grande mediante FTP e importarlo desde el servidor.',
	'You are offline.' => 'Usted no esta en linea.',
	'Menu' => 'Menú',
	'Documentation' => 'Documentación', // Claude Opus 5
	'Database management in a single PHP file' => 'Gestión de bases de datos en un único archivo PHP',
	'Logged in as: %s' => 'Logueado como: %s',
	'Functions' => 'Funciones',
	...
	'Move to another database' => 'Mover a otra base de datos',
	'Move' => 'Mover',
	'Engine' => 'Motor',
	...
	'History' => 'Histórico',
	'Variables' => 'Variables',
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'Las columnas de origen y destino deben ser del mismo tipo, debe existir un índice entre las columnas del destino y el registro referenciado debe existir también.',
	...
	'Lists' => 'Listas',
	'Editor' => 'Editor',
	'Data editing in a single PHP file' => 'Edición de datos en un único archivo PHP',
	...
	'Type has been altered.' => 'Tipo modificado.',
	'Extensions' => 'Extensiones', // Claude Opus 5
	'Version' => 'Versión', // Claude Opus 5
	'Ctrl+click on a value to modify it.' => 'Ctrl+clic sobre el valor para editarlo.',
	'Use the edit link to modify this value.' => 'Utilice el enlace de edición para realizar cambios.',
	'last' => 'último',
	...
	'%d query(ies) executed OK.' => array('%d sentencia SQL ejecutada correctamente.', '%d sentencias SQL ejecutadas correctamente.'),
	'Show only errors' => 'Mostrar solamente errores',
	'Refresh' => 'Actualizar',
	'Please use one of these file extensions: %s.' => 'Por favor, use una de las extensiones %s.',
	'now' => 'ahora',
	'ltr' => 'ltr',
	...
	'Every plugin must <a%s>be an object</a>.' => 'Cada plugin tiene que <a%s>ser un objeto</a>.',
	...
	'The server accepts any password, so filling it in protects nothing.' => 'El servidor acepta cualquier contraseña, así que ingresarla no protege nada.',
	'Require a password.' => 'Requerir una contraseña.',
	'Save %s next to Adminer to require the entered password:' => 'Guarde %s junto a Adminer para requerir la contraseña ingresada:',
	'Save %s next to Adminer to require the password %s:' => 'Guarde %s junto a Adminer para requerir la contraseña %s:',
	'Add this line to %s to require the entered password:' => 'Añada esta línea a %s para requerir la contraseña ingresada:',
	'Add this line to %s to require the password %s:' => 'Añada esta línea a %s para requerir la contraseña %s:',
	'More options' => 'Más opciones',
	'Require a password verified by Adminer' => 'Requiere una contraseña verificada por Adminer',
	'Too many unsuccessful logins, try again in %d minute(s).' => array('Demasiados intentos de acceso fallidos, intente nuevamente en %d minuto.', 'Demasiados intentos de acceso fallidos, intente nuevamente en %d minutos.'),
	...
	'Drop %s?' => '¿Eliminar %s?',
	'Tables have been optimized.' => 'Las tablas se optimizaron.',
	'Vacuum' => 'Limpiar',
	...
	'Columns' => 'Columnas',
	'Condition' => 'Condición',
	'All rows on this page' => 'Todas las filas de esta página',
	'Modify' => 'Modificar',
	'Load more data' => 'Cargar más datos',
	'Loading…' => 'Cargando…',
	'%d / ' => '%d / ',
	'Limit rows' => 'Límite de registros',
	'Inherits from' => 'Hereda de',
	'Inherited by' => 'Heredada por',
	'Shadow tables' => 'Tablas sombra',
	'hostname[:port] or :socket' => 'hostname[:port] o :socket',
	'Default value' => 'Valor predeterminado',
	'Full table scan' => 'Escaneo de la tabla completa',
	'Thanks for using Adminer. Consider <a href="https://www.adminer.org/en/donation/">donating</a>.' => 'Gracias por usar Adminer, considere <a href="https://www.adminer.org/en/donation/">hacer una donación</a>.',
	'Invalid server.' => 'Servidor no válido.',
	'Size' => 'Tamaño',
	'Compute' => 'Calcular',
