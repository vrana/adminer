...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'Token CSRF inválido. Enviar o formulario novamente.',
	'Comment' => 'Comentário',
	...
	'Session expired. Please log in again.' => 'Sessão expirada, por favor entre de novo.',
	...
	'Alter' => 'Modificar',
	'Alter foreign key' => 'Modificar Chave estrangeira', // Claude Opus 5
	'Create foreign key' => 'Criar Chave estrangeira', // Claude Opus 5
	'ON DELETE' => 'ON DELETE',
	'ON UPDATE' => 'ON UPDATE',
	'Index Type' => 'Tipo de índice',
	'length' => 'tamanho',
	'operator class' => 'classe de operadores', // Claude Fable 5
	...
	'Grant' => 'Conceder',
	'Revoke' => 'Impedir',
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'POST data demasiado grande. Reduza o tamanho ou aumente a diretiva de configuração %s.',
	'Logged in as: %s' => 'Ligado como: %s',
	'Functions' => 'Funções',
	'Aggregation' => 'Adições',
	'Export' => 'Exportar',
	'Output' => 'Saída',
	...
	'Move to another database' => 'Mover para outra Base de dados',
	'Move' => 'Mover',
	'Engine' => 'Motor',
	'Save and continue editing' => 'Guardar e continuar a edição',
	'original' => 'original',
	...
	'History' => 'Histórico',
	'Variables' => 'Variáveis',
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'As colunas de origem e destino devem ser do mesmo tipo, deve existir um índice entre as colunas de destino e o registo referenciado deve existir.',
	'Relations' => 'Relações',
	...
	'Lists' => 'Listas',
	'Editor' => 'Editor',
	'Data editing in a single PHP file' => 'Edição de dados num único ficheiro PHP', // Claude Opus 5
	...
	'Type has been altered.' => 'Tipo modificado.', // Claude Opus 5
	'Extensions' => 'Extensões', // Claude Opus 5
	'Version' => 'Versão', // Claude Opus 5
	'Ctrl+click on a value to modify it.' => 'Ctrl+clique vezes sobre o valor para edita-lo.',
	'Use the edit link to modify this value.' => 'Utilize o link modificar para alterar.',
	'last' => 'último',
	...
	'%d query(ies) executed OK.' => array('%d consulta sql executada corretamente.', '%d consultas sql executadas corretamente.'),
	'Show only errors' => 'Mostrar somente erros',
	'Refresh' => 'Atualizar',
	'Invalid schema.' => 'Esquema inválido.',
	'Please use one of these file extensions: %s.' => 'Por favor use uma das extensões %s.',
	'now' => 'agora',
	'ltr' => 'ltr',
	'Check has been dropped.' => 'A verificação foi removida.', // Claude Fable 5
	'Check has been altered.' => 'A verificação foi modificada.', // Claude Fable 5
	'Check has been created.' => 'A verificação foi criada.', // Claude Fable 5
	'Alter check' => 'Modificar verificação', // Claude Fable 5
	'Create check' => 'Criar verificação', // Claude Fable 5
	'Drop %s?' => 'Remover %s?', // Claude Fable 5
	...
	'Permanent link' => 'Ligação permanente', // Claude Fable 5
	'File must be in UTF-8 encoding.' => 'O ficheiro deve estar codificado em UTF-8.', // Claude Fable 5
	'All rows on this page' => 'Todas as linhas desta página', // Claude Opus 5
	'Modify' => 'Modificar', // Claude Fable 5
	'Load more data' => 'Carregar mais dados', // Claude Fable 5
	'Loading…' => 'A carregar…', // Claude Fable 5
	'%s queries are not supported.' => 'As consultas %s não são suportadas.', // Claude Fable 5
	'Warnings' => 'Avisos', // Claude Fable 5
	'%d / ' => '%d / ', // Claude Fable 5
	'Limit rows' => 'Limite de registos', // Claude Fable 5
	'Edit all' => 'Editar tudo', // Claude Fable 5
	'Materialized view' => 'Vista materializada', // Claude Fable 5
	'Inherits from' => 'Herda de', // Claude Fable 5
	'Checks' => 'Verificações', // Claude Fable 5
	'Inherited by' => 'Herdada por', // Claude Fable 5
	'Shadow tables' => 'Tabelas sombra', // Claude Opus 5
	'hostname[:port] or :socket' => 'hostname[:port] ou :socket', // Claude Fable 5
	'Adminer does not support accessing a database without a password.' => 'O Adminer não suporta aceder a uma base de dados sem senha.', // Claude Fable 5
	'Default value' => 'Valor predeterminado', // Claude Fable 5
	'Full table scan' => 'Varrimento completo da tabela', // Claude Fable 5
	'Too many unsuccessful logins, try again in %d minute(s).' => array('Demasiadas tentativas de início de sessão falhadas, tente novamente em %d minuto.', 'Demasiadas tentativas de início de sessão falhadas, tente novamente em %d minutos.'), // Claude Fable 5
	'Use the %s <a%s>plugin</a> if Adminer runs behind a reverse proxy.' => 'Utilize o <a%2$s>plugin</a> %1$s se o Adminer for executado atrás de um proxy inverso.', // Claude Opus 5
	'Thanks for using Adminer. Consider <a href="https://www.adminer.org/en/donation/">donating</a>.' => 'Obrigado por usar o Adminer, considere <a href="https://www.adminer.org/en/donation/">fazer um donativo</a>.', // Claude Fable 5
	'Master password expired. <a href="https://www.adminer.org/en/extension/"%s>Implement</a> the %s method to make it permanent.' => 'A senha mestra expirou. <a href="https://www.adminer.org/en/extension/"%s>Implemente</a> o método %s para a tornar permanente.', // Claude Fable 5
	'The action will be performed after successful login with the same credentials.' => 'A ação será realizada após iniciar sessão com êxito com as mesmas credenciais.', // Claude Fable 5
	'Invalid server.' => 'Servidor inválido.', // Claude Fable 5
	'Connecting to privileged ports is not allowed.' => 'Não é permitido ligar a portos privilegiados.', // Claude Fable 5
	'There is a space in the entered password, which might be the cause.' => 'Existe um espaço na senha introduzida que pode ser a causa.', // Claude Fable 5
	'If you did not send this request from Adminer, close this page.' => 'Se não enviou este pedido a partir do Adminer, feche esta página.', // Claude Fable 5
	'Not found.' => 'Não encontrado.', // Claude Opus 5
	'You can upload a large SQL file via FTP and import it from the server.' => 'Pode enviar um ficheiro SQL grande por FTP e importá-lo a partir do servidor.', // Claude Fable 5
	'Size' => 'Tamanho', // Claude Fable 5
	'Compute' => 'Calcular', // Claude Fable 5
	'Loaded plugins' => 'Plugins carregados', // Claude Fable 5
	'screenshot' => 'captura de ecrã', // Claude Fable 5
	'You are offline.' => 'Está offline.', // Claude Fable 5
	'Menu' => 'Menu', // Claude Opus 5
	'Database management in a single PHP file' => 'Gestão de bases de dados num único ficheiro PHP', // Claude Opus 5
	'Increase %s.' => 'Aumente %s.', // Claude Fable 5
	'You have no privileges to update this table.' => 'Não tem privilégios para atualizar esta tabela.', // Claude Fable 5
	'Saving…' => 'A guardar…', // Claude Fable 5
	'Unknown error.' => 'Erro desconhecido.', // Claude Fable 5
	'%s must <a%s>return an array</a>.' => '%s deve <a%s>devolver um array</a>.', // Claude Fable 5
	...
	'Disable %s or enable the %s or %s extension.' => 'Desative %s ou ative as extensões %s ou %s.', // Claude Fable 5
	'The database does not support passwords.' => 'A base de dados não suporta senha.', // Claude Fable 5
	'The server accepts any password, so filling it in protects nothing.' => 'O servidor aceita qualquer senha, por isso preenchê-la não protege nada.', // Claude Opus 5
	'Require a password.' => 'Exigir uma senha.', // Claude Opus 5
	'Save %s next to Adminer to require the entered password:' => 'Guarde %s junto ao Adminer para exigir a senha introduzida:', // Claude Opus 5
	'Save %s next to Adminer to require the password %s:' => 'Guarde %s junto ao Adminer para exigir a senha %s:', // Claude Opus 5
	'Add this line to %s to require the entered password:' => 'Adicione esta linha a %s para exigir a senha introduzida:', // Claude Opus 5
	'Add this line to %s to require the password %s:' => 'Adicione esta linha a %s para exigir a senha %s:', // Claude Opus 5
	'More options' => 'Mais opções', // Claude Opus 5
	'Require a password verified by Adminer' => 'Exige uma senha verificada pelo Adminer', // Claude Opus 5
