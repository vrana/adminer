...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'Nederīgs CSRF žetons. Nosūtiet formu vēl vienu reizi.',
	'Comment' => 'Komentārs',
	...
	'Session expired. Please log in again.' => 'Sesijas laiks ir beidzies, piesakies no jauna sistēmā.',
	...
	'Alter' => 'Izmainīt',
	'Alter foreign key' => 'Izmainīt ārējo atslēgu', // Claude Opus 5
	'Create foreign key' => 'Izveidot ārējo atslēgu', // Claude Opus 5
	...
	'Grant' => 'Atļaut',
	'Revoke' => 'Aizliegt',
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'POST metodes pieprasījums apjoms par lielu. Atsūtiet mazāka apjoma pieprasījumu kā konfigurācijas %s.',
	'Logged in as: %s' => 'Ielogojies kā: %s',
	'Functions' => 'Funkcijas',
	...
	'Move to another database' => 'Pārvietot uz citu datubāzi',
	'Move' => 'Pārvietot',
	'Engine' => 'Dzinējs',
	...
	'History' => 'Vēsture',
	'Variables' => 'Mainīgie',
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'Lauku tipiem jābūt vienādiem, rezultējošā laukā jābut indeksa datiem.',
	'Relations' => 'Relācijas',
	...
	'Use the edit link to modify this value.' => 'Izmainīt vērtību var tikai ar saiti \'Izmainīt\'.',
	'last' => 'pēdējā',
	...
	'%d query(ies) executed OK.' => array('%d pieprasījums veiksmīgs.', '%d pieprasījumi veiksmīgi.', '%d pieprasījumi veiksmīgi.'),
	'Show only errors' => 'Rādīt tikai kļūdas',
	'Refresh' => 'Atjaunot',
	'Invalid schema.' => 'Nederīga shēma.',
	'Please use one of these file extensions: %s.' => 'Izmainojiet kādu no paplašinājumiem %s.',
	'now' => 'tagad',
	'ltr' => 'ltr',
	...
	'Master password expired. <a href="https://www.adminer.org/en/extension/"%s>Implement</a> the %s method to make it permanent.' => 'Master-parole nav derīga. <a href="https://www.adminer.org/en/extension/"%s>Implementējiet</a> metodi %s, lai padarīgu šo par ierastu metodi.',
	'If you did not send this request from Adminer, close this page.' => 'Ja nesūtījāt šo pieprasījumu no Adminer, tad aizveriet pārlūka logu.',
	'You can upload a large SQL file via FTP and import it from the server.' => 'Varat ielādēt lielu SQL failu uz servera un tad importēt to.',
	'Size' => 'Izmērs',
	'Compute' => 'Izskaitļot',
	...
	'There is a space in the entered password, which might be the cause.' => 'Parole satur atstarpi, kas varētu būt lieka.',
	'Unknown error.' => 'Nezināma kļūda.',
	'The database does not support passwords.' => 'Datubāze neatbalsta paroli.',
);
