...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'Neplatný token CSRF. Odošlite formulár znova.',
	'Comment' => 'Komentár',
	...
	'File uploads are disabled.' => 'Nahrávanie súborov nie je povolené.',
	...
	'Session expired. Please log in again.' => 'Session vypršala, prihláste sa prosím znova.',
	...
	'Grant' => 'Povoliť',
	'Revoke' => 'Zakázať',
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'Príliš veľké POST dáta. Zmenšite dáta alebo zvýšte hodnotu konfiguračnej direktívy %s.',
	'Logged in as: %s' => 'Prihlásený ako: %s',
	'Functions' => 'Funkcie',
	...
	'End' => 'Koniec',
	'Status' => 'Stav',
	'On completion preserve' => 'Po dokončení zachovať',
	'Save and continue editing' => 'Uložiť a pokračovať v úpravách',
	'original' => 'originál',
	'Tables have been truncated.' => 'Tabuľky boli vyprázdnené.',
	'Tables have been moved.' => 'Tabuľky boli presunuté.',
	'Tables have been dropped.' => 'Tabuľky boli odstránené.',
	...
	'Repair' => 'Opraviť',
	'Truncate' => 'Vyprázdniť',
	'Move to another database' => 'Presunúť do inej databázy',
	'Move' => 'Presunúť',
	...
	'History' => 'História',
	'Variables' => 'Premenné',
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'Zdrojové a cieľové stĺpce musia mať rovnaký datový typ, nad cieľovými stĺpcami musí byť definovaný index a odkazované dáta musia existovať.',
	...
	'Clear' => 'Vyčistiť',
	'Editor' => 'Editor',
	'Data editing in a single PHP file' => 'Úprava dát v jednom PHP súbore',
	...
	'Type has been altered.' => 'Typ bol zmenený.',
	'Alter type' => 'Pozmeniť typ',
	'Extensions' => 'Rozšírenia', // Claude Opus 5
	'Version' => 'Verzia', // Claude Opus 5
	'Ctrl+click on a value to modify it.' => 'Ctrl+kliknite na políčko, ktoré chcete zmeniť.',
	'Use the edit link to modify this value.' => 'Pre zmenu tejto hodnoty použite odkaz upraviť.',
	'last' => 'posledný',
	...
	'%d query(ies) executed OK.' => array('Bol vykonaný %d dotaz.', 'Boli vykonané %d dotazy.', 'Bolo vykonaných %d dotazov.'),
	'Show only errors' => 'Zobraziť iba chyby',
	'Refresh' => 'Obnoviť',
	'Please use one of these file extensions: %s.' => 'Prosím vyberte jednu z koncoviek %s.',
	'now' => 'teraz',
	'ltr' => 'ltr',
	...
	'overwrite' => 'prepísať',
	'DB' => 'DB',
	'System%s' => 'Systémové%s', // Claude Opus 5
	...
	'Use the %s <a%s>plugin</a> if Adminer runs behind a reverse proxy.' => 'Ak Adminer beží za reverznou proxy, použite <a%2$s>plugin</a> %1$s.',
	...
	'Menu' => 'Menu',
	'Documentation' => 'Dokumentácia', // Claude Opus 5
	'Database management in a single PHP file' => 'Správa databázy v jednom PHP súbore',
	...
	'The server accepts any password, so filling it in protects nothing.' => 'Server prijme akékoľvek heslo, takže jeho vyplnenie nič nechráni.',
	'Require a password.' => 'Vyžadovať heslo.',
	'Save %s next to Adminer to require the entered password:' => 'Uložte %s vedľa Adminera, aby vyžadoval zadané heslo:',
	'Save %s next to Adminer to require the password %s:' => 'Uložte %s vedľa Adminera, aby vyžadoval heslo %s:',
	'Add this line to %s to require the entered password:' => 'Pridajte tento riadok do súboru %s, aby Adminer vyžadoval zadané heslo:',
	'Add this line to %s to require the password %s:' => 'Pridajte tento riadok do súboru %s, aby Adminer vyžadoval heslo %s:',
	'More options' => 'Ďalšie možnosti',
	'Require a password verified by Adminer' => 'Vyžaduje heslo overované Adminerom',
	'Disable %s or enable the %s or %s extension.' => 'Zakážte %s alebo povoľte rozšírenie %s alebo %s.',
	'yes' => 'áno',
	'no' => 'nie',
	'Checks' => 'Kontroly',
	...
	'Columns' => 'Stĺpce',
	'Condition' => 'Podmienka',
	'Inherits from' => 'Zdedená z',
	'Inherited by' => 'Zdedené',
	'Shadow tables' => 'Tieňové tabuľky',
	'hostname[:port] or :socket' => 'hostname[:port] alebo :socket',
	'Invalid server.' => 'Neplatný server.',
	'Loaded plugins' => 'Načítané pluginy',
	'screenshot' => 'obrázok',
	'Increase %s.' => 'Zvýšte %s.',
	'%s must <a%s>return an array</a>.' => '%s musí <a%s>vracať pole</a>.',
	'<a%s>Configure</a> %s in %s.' => '<a%s>Nakonfigurujte</a> %s v %s.',
	'Every plugin must <a%s>be an object</a>.' => 'Každý plugin musí <a%s>byť objekt</a>.',
);
