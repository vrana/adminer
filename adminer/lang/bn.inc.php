...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'অবৈধ CSRF টোকেন। ফর্মটি আবার পাঠান।',
	'Comment' => 'মন্তব্য',
	...
	'Session expired. Please log in again.' => 'সেশনের মেয়াদ শেষ হয়েছে, আবার লগইন করুন।',
	...
	'Alter' => 'পরিবর্তন',
	'Alter foreign key' => 'ফরেন কী পরিবর্তন করুন', // Claude Opus 5
	'Create foreign key' => 'ফরেন কী তৈরী করুন', // Claude Opus 5
	'ON DELETE' => 'অন ডিলিট',
	'ON UPDATE' => 'অন আপডেট',
	'Index Type' => 'সূচী-ধরণ',
	'length' => 'দৈর্ঘ্য',
	...
	'Grant' => 'অনুমতি',
	'Revoke' => 'প্রত্যাহার',
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'খুব বড় POST ডাটা। ডাটা সংক্ষিপ্ত করো অথবা %s কনফিগারেশন নির্দেশ বৃদ্ধি করো।',
	'Logged in as: %s' => '%s হিসাবে লগড',
	...
	'Move to another database' => 'অন্য ডাটাবেজে স্থানান্তর করুন',
	'Move' => 'স্থানান্তর করুন',
	'Engine' => 'ইঞ্জিন',
	'Save and continue editing' => 'সংরক্ষণ করুন এবং সম্পাদনা চালিয়ে যান',
	'original' => 'প্রকৃত',
	...
	'History' => 'ইতিহাস',
	'Variables' => 'চলকসমূহ',
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'সোর্স এবং টার্গেট কলামে একই ডাটা টাইপ থাকতে হবে, টার্গেট কলামসমূহে একটি সূচী এবং রেফারেন্সড ডেটার উপস্থিতি থাকা আবশ্যক।',
	'Relations' => 'সম্পর্ক',
	'Run file' => 'ফাইল চালাও',
	'Clear' => 'সাফ করো',
	...
	'Use the edit link to modify this value.' => 'এই মানটি পরিবর্তনের জন্য সম্পাদনা লিঙ্ক ব্যবহার করুন।',
	'last' => 'সর্বশেষ',
	...
	'%d query(ies) executed OK.' => array('SQL-অনুসন্ধান সফলভাবে সম্পন্ন হয়েছে।', '%d SQL-অনুসন্ধানসমূহ সফলভাবে সম্পন্ন হয়েছে।'),
	'Show only errors' => 'শুধুমাত্র ত্রুটিগুলো দেখান',
	'Refresh' => 'রিফ্রেশ',
	'Invalid schema.' => 'অবৈধ স্কিমা।',
	'Please use one of these file extensions: %s.' => 'কোন একটা এক্সটেনশন %s ব্যবহার করুন।',
	'now' => 'এখন',
	'ltr' => 'ltr',
	...
	'Master password expired. <a href="https://www.adminer.org/en/extension/"%s>Implement</a> the %s method to make it permanent.' => 'মাস্টার পাসওয়ার্ডের মেয়াদ শেষ হয়েছে। এটিকে স্থায়ী করতে <a href="https://www.adminer.org/en/extension/"%s>ইমপ্লিমেন্ট</a> %s মেথড।',
	...
	'There is a space in the entered password, which might be the cause.' => 'ইনপুট পাসওয়ার্ডে একটি স্পেস রয়েছে যা এর কারণ হতে পারে।',
	'If you did not send this request from Adminer, close this page.' => 'আপনি যদি Adminer থেকে এই অনুরোধ না করে থাকেন তবে এই পৃষ্ঠাটি বন্ধ করুন।',
	'You can upload a large SQL file via FTP and import it from the server.' => 'আপনি FTP এর মাধ্যমে একটি বড় SQL ফাইল আপলোড করতে পারেন এবং সার্ভার থেকে এটি ইম্পোর্ট করতে পারেন।',
	'Size' => 'আকার',
	'Compute' => 'কম্পিউট',
	...
	'Disable %s or enable the %s or %s extension.' => '%s নিষ্ক্রিয় করুন অথবা %s বা %s এক্সটেনশন সক্রিয় করুন।',
	'The database does not support passwords.' => 'ডাটাবেস পাসওয়ার্ড সমর্থন করে না।',
	'yes' => 'হ্যাঁ',
	'no' => 'না',
);
