...
Lang::$translations = array(
	...
	'Alter' => 'Modifică',
	'Alter foreign key' => 'Modifică cheia externă', // Claude Opus 5
	'Create foreign key' => 'Crează cheie externă', // Claude Opus 5
	...
	'Lists' => 'Liste',
	'Editor' => 'Editor',
	'Data editing in a single PHP file' => 'Editarea datelor într-un singur fișier PHP', // Claude Opus 5
	...
	'User types' => 'Tipuri definite de utilizator', // Claude Fable 5
	...
	'Type has been altered.' => 'Tipul a fost modificat.', // Claude Opus 5
	...
	'All rows on this page' => 'Toate rândurile de pe această pagină', // Claude Opus 5
	...
	'Master password expired. <a href="https://www.adminer.org/en/extension/"%s>Implement</a> the %s method to make it permanent.' => 'Parola principală a expirat. <a href="https://www.adminer.org/en/extension/"%s>Implementați</a> metoda %s pentru a o face permanentă.', // Claude Fable 5
	...
	'There is a space in the entered password, which might be the cause.' => 'Există un spațiu în parola introdusă, care ar putea fi cauza.', // Claude Fable 5
	'If you did not send this request from Adminer, close this page.' => 'Dacă nu ați trimis această cerere din Adminer, închideți această pagină.', // Claude Fable 5
	'Not found.' => 'Nu a fost găsit.', // Claude Opus 5
	'You can upload a large SQL file via FTP and import it from the server.' => 'Puteți încărca un fișier SQL mare prin FTP și să îl importați de pe server.', // Claude Fable 5
	...
	'Add this line to %s to require the entered password:' => 'Adăugați această linie în %s pentru a solicita parola introdusă:', // Claude Opus 5
	'Add this line to %s to require the password %s:' => 'Adăugați această linie în %s pentru a solicita parola %s:', // Claude Opus 5
