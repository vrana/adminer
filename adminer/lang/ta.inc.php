...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'CSRF டோக்க‌ன் செல்லாது. ப‌டிவ‌த்தை மீண்டும் அனுப்ப‌வும்.',
	'Comment' => 'குறிப்பு',
	...
	'Session expired. Please log in again.' => 'செஷ‌ன் காலாவ‌தியாகி விட்ட‌து. மீண்டும் நுழைய‌வும்.',
	...
	'Alter' => 'மாற்று',
	'Alter foreign key' => 'வேற்று விசையை மாற்று', // Claude Opus 5
	'Create foreign key' => 'வேற்று விசையை உருவாக்கு', // Claude Opus 5
	'ON DELETE' => 'ON DELETE',
	'ON UPDATE' => 'ON UPDATE',
	...
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'மிக‌ அதிக‌மான‌ POST த‌க‌வ‌ல். த‌க‌வ‌லை குறைக்க‌வும் அல்ல‌து %s வ‌டிவ‌மைப்பை (configuration directive) மாற்ற‌வும்.',
	'Logged in as: %s' => 'ப‌ய‌னாளர்: %s',
	'Functions' => 'Functions',
	...
	'Move to another database' => 'ம‌ற்ற‌ த‌க‌வ‌ல் தள‌த்திற்க்கு ந‌க‌ர்த்து',
	'Move' => 'ந‌க‌ர்த்து',
	'Engine' => 'எஞ்சின் (Engine)',
	'Save and continue editing' => 'சேமித்த‌ பிற‌கு தொகுப்ப‌தை தொட‌ர‌வும்',
	'original' => 'அச‌ல்',
	...
	'Clone' => 'ந‌க‌லி (Clone)',
	'Maximum number of allowed fields exceeded. Please increase %s.' => 'அனும‌திக்க‌ப்ப‌ட்ட‌ அதிக‌ப‌ட்ச‌ கோப்புக‌ளின் எண்ணிக்கை மீற‌ப்ப‌ட்ட‌து. த‌ய‌வு செய்து %s யை அதிக‌ரிக்க‌வும்.', // Claude Fable 5
	...
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'இல‌க்கு நெடுவ‌ரிசையில் அக‌வ‌ரிசை (Index) ம‌ற்றும் குறிக்க‌ப்ப‌ட்ட‌ த‌க‌வல் (Referenced DATA) க‌ண்டிப்பாக‌ இருத்த‌ல் வேண்டும். மூல‌ நெடுவ‌ரிசை ம‌ற்றும் இலக்கு நெடுவ‌ரிசையின் த‌க‌வ‌ல் வ‌டிவ‌ம் (DATA TYPE) ஒன்றாக‌ இருக்க‌ வேண்டும்.',
	...
	'Use the edit link to modify this value.' => 'இந்த‌ ம‌திப்பினை மாற்ற‌, தொகுப்பு இணைப்பினை உப‌யோகிக்க‌வும்.',
	'last' => 'க‌டைசி',
	...
	'now' => 'இப்பொழுது',
	'%d query(ies) executed OK.' => array('%d வின‌வ‌ல் செய‌ல்ப‌டுத்த‌ப்ப‌ட்ட‌து.', '%d வின‌வ‌ல்க‌ள் செய‌ல்ப‌டுத்த‌ப்ப‌ட்ட‌ன‌.'),
	...
	'Please use one of these file extensions: %s.' => 'த‌ய‌வு செய்து ஒரு விரிவினை %s (extension) உப‌யோகிக்க‌வும்.',
	'ltr' => 'ltr',
