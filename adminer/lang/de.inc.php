...
Lang::$translations = array(
	...
	'Invalid CSRF token. Submit the form again.' => 'CSRF Token ungültig. Bitte die Formulardaten erneut abschicken.',
	'Comment' => 'Kommentar',
	...
	'Session expired. Please log in again.' => 'Sitzungsdauer abgelaufen, bitte erneut anmelden.',
	...
	'Alter' => 'Ändern',
	'Alter foreign key' => 'Fremdschlüssel ändern',
	'Create foreign key' => 'Fremdschlüssel erstellen',
	'ON DELETE' => 'ON DELETE',
	'ON UPDATE' => 'ON UPDATE',
	...
	'Grant' => 'Erlauben',
	'Revoke' => 'Widerrufen',
	'The POST data is too large. Reduce the data or increase the %s configuration directive.' => 'POST-Daten sind zu groß. Reduzieren Sie die Größe oder vergrößern Sie den Wert %s in der Konfiguration.',
	...
	'Move to another database' => 'In andere Datenbank verschieben',
	'Move' => 'Verschieben',
	'Engine' => 'Speicher-Engine',
	...
	'History' => 'History',
	'Variables' => 'Variablen',
	'Source and target columns must have the same data type, there must be an index on the target columns and the referenced data must exist.' => 'Quell- und Zielspalten müssen vom gleichen Datentyp sein, es muss unter den Zielspalten ein Index existieren und die referenzierten Daten müssen existieren.',
	...
	'Lists' => 'Listen',
	'Editor' => 'Editor',
	'Data editing in a single PHP file' => 'Datenbearbeitung in einer einzigen PHP-Datei',
	...
	'Type has been altered.' => 'Typ wurde geändert.',
	'Extensions' => 'Erweiterungen', // Claude Opus 5
	'Version' => 'Version', // Claude Opus 5
	'Ctrl+click on a value to modify it.' => 'Ctrl+Klick zum Bearbeiten des Wertes.',
	'Use the edit link to modify this value.' => 'Benutzen Sie den Link zum Bearbeiten dieses Wertes.',
	'last' => 'letzte',
	...
	'%d query(ies) executed OK.' => array('SQL-Abfrage erfolgreich ausgeführt.', '%d SQL-Abfragen erfolgreich ausgeführt.'),
	'Show only errors' => 'Nur Fehler anzeigen',
	'Refresh' => 'Aktualisieren',
	'Invalid schema.' => 'Schema nicht gültig.',
	'Please use one of these file extensions: %s.' => 'Bitte einen der Dateitypen %s benutzen.',
	'now' => 'jetzt',
	'ltr' => 'ltr',
	...
	'Compute' => 'kalkulieren',
	'Size' => 'Größe',
	'All rows on this page' => 'Alle Zeilen auf dieser Seite',
	'Modify' => 'Ändern',
	...
	'Use the %s <a%s>plugin</a> if Adminer runs behind a reverse proxy.' => 'Verwenden Sie das <a%2$s>Plugin</a> %1$s, wenn Adminer hinter einem Reverse Proxy läuft.',
	'If you did not send this request from Adminer, close this page.' => 'Wenn Sie diese Anfrage nicht von Adminer gesendet haben, schließen Sie diese Seite.',
	'Not found.' => 'Nicht gefunden.', // Claude Opus 5
	...
	'yes' => 'ja',
	'no' => 'nein',
	'Master password expired. <a href="https://www.adminer.org/en/extension/"%s>Implement</a> the %s method to make it permanent.' => 'Das Master-Passwort ist abgelaufen. <a href="https://www.adminer.org/de/extension/"%s>Implementieren</a> Sie die %s Methode, um es permanent zu machen.',
	'%d / ' => '%d / ',
	'Drop %s?' => '%s entfernen?',
	'Materialized view' => 'Materialisierte View',
	'Vacuum' => 'Vacuum',
	...
	'There is a space in the entered password, which might be the cause.' => 'Es gibt ein Leerzeichen im Eingabepasswort, das die Ursache sein könnte.',
	'Unknown error.' => 'Unbekannter Fehler.',
	'The database does not support passwords.' => 'Die Datenbank unterstützt kein Passwort.',
	'The server accepts any password, so filling it in protects nothing.' => 'Der Server akzeptiert jedes Passwort, das Ausfüllen schützt also nichts.',
	'Require a password.' => 'Ein Passwort verlangen.',
	'Save %s next to Adminer to require the entered password:' => 'Speichern Sie %s neben Adminer, um das eingegebene Passwort zu verlangen:',
	'Save %s next to Adminer to require the password %s:' => 'Speichern Sie %s neben Adminer, um das Passwort %s zu verlangen:',
	'Add this line to %s to require the entered password:' => 'Fügen Sie diese Zeile zu %s hinzu, um das eingegebene Passwort zu verlangen:',
	'Add this line to %s to require the password %s:' => 'Fügen Sie diese Zeile zu %s hinzu, um das Passwort %s zu verlangen:',
	'More options' => 'Weitere Optionen',
	'Require a password verified by Adminer' => 'Verlangt ein von Adminer geprüftes Passwort',
	'Disable %s or enable the %s or %s extension.' => 'Deaktivieren Sie %s oder aktivieren Sie die Erweiterungen %s oder %s.',
	'Check has been dropped.' => 'Check wurde entfernt.',
	...
	'Every plugin must <a%s>be an object</a>.' => 'Jedes Plugin muss <a%s>ein Objekt sein</a>.',
	'screenshot' => 'Screenshot',
	'Algorithm' => 'Algorithmus',
	'Condition' => 'Bedingung',
	'Inherits from' => 'Erbt von',
	'Inherited by' => 'Vererbt an',
	'Shadow tables' => 'Schattentabellen',
	'hostname[:port] or :socket' => 'hostname[:port] oder :socket',
	'Invalid server.' => 'Ungültiger Server.',
	'Increase %s.' => 'Erhöhen Sie %s.',
);
