...
/** Save menu scrollbar position on reload
 * 
 */
function saveMenuPosition(){
    if(typeof(Storage)!== undefined)
    {
        sessionStorage.menu_pos = document.getElementById('menu').scrollTop;
    }
}
...
function loadMenuPosition(){
    if(typeof(Storage)!== undefined)
    {
        if(sessionStorage.menu_pos !== undefined)
            document.getElementById('menu').scrollTop = sessionStorage.menu_pos;
    }
    document.getElementById('menu').onscroll = saveMenuPosition;
}