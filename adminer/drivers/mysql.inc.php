...
if (!defined("DRIVER")) {
	...
	* @param string "comment", "copy", "drop_col", "dump", "event", "kill", "partitioning", "privileges", "procedure", "processlist", "routine", "scheme", "sequence", "status", "trigger", "truncate", "type", "variables", "view"
	* @return bool
	*/
